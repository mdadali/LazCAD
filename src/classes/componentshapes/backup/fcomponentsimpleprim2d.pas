...
function  TCADSysSimplePrimitive2D.GetPen: TPen;
begin
  result := fSimplePrimitive2D.Pen;
end;

procedure TCADSysSimplePrimitive2D.SetPen(APen: TPen);
begin
  fSimplePrimitive2D.Pen := APen;
end;
