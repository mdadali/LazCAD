...
function  TCADSysPrimitive2D.GetCenterPointX: TRealType;
begin
  result := fPrimitive2D.CenterPoint.X;
end;

function  TCADSysPrimitive2D.GetCenterPointY: TRealType;
begin
  result := fPrimitive2D.CenterPoint.Y;
end;

function  TCADSysPrimitive2D.GetCenterPoint: TPoint2D;
begin
...
procedure TCADSysPrimitive2D.SetCenterPointX(AValue: TRealType);
begin
  fPrimitive2D.CenterPointX := AValue;
end;

procedure TCADSysPrimitive2D.SetCenterPointY(AValue: TRealType);
begin
