...
(**************[  Vertex type   ]***************)
type TFGPoint2DPtr    = ^TFGPoint2D;
     TFGPoint2D       = record x,y:TFloat; end;
     TFGPoint2DArray  = array of TFGPoint2D;


(**************[ 3D Vertex type ]***************)
type TFGPoint3DPtr    = ^TFGPoint3D;
     TFGPoint3D       = record x,y,z:TFloat; end;
     TFGPoint3DArray  = array of TFGPoint3D;


(**************[  Quadix type   ]***************)
type TFGQuadix2DPtr   = ^TFGQuadix2D;
     TFGQuadix2D      = array [1..4] of TFGPoint2D;
     TFGQuadix2DArray = array of TFGQuadix2D;

type TFGQuadix3DPtr   = ^TFGQuadix3D;
     TFGQuadix3D      = array [1..4] of TFGPoint3D;
     TFGQuadix3DArray = array of TFGQuadix3D;


(**************[ Rectangle type ]***************)
type TFGRectanglePtr   = ^TFGRectangle;
     TFGRectangle      = array [1..2] of TFGPoint2D;
     TFGRectangleArray = array of TFGRectangle;


(**************[   Box type     ]***************)
type TFGBoxPtr   = ^TFGRectangle;
     TFGBox      = array [1..2] of TFGPoint3D;
     TFGBoxArray = array of TFGBox;


(**************[ Triangle type  ]***************)
type TFGTriangle2DPtr   = ^TFGTriangle2D;
     TFGTriangle2D      = array [1..3] of TFGPoint2D;
     TFGTriangle2DArray = array of TFGTriangle2D;

type TFGTriangle3DPtr   = ^TFGTriangle3D;
     TFGTriangle3D      = array [1..3] of TFGPoint3D;
     TFGTriangle3DArray = array of TFGTriangle3D;


(**************[  Segment type  ]***************)
type TFGSegment2DPtr   = ^TFGSegment2D;
     TFGSegment2D      = array [1..2] of TFGPoint2D;
     TFGSegment2DArray = array of TFGSegment2D;

type TFGSegment3DPtr   = ^TFGSegment3D;
     TFGSegment3D      = array [1..2] of TFGPoint3D;
     TFGSegment3DArray = array of TFGSegment3D;


(**************[  Line type  ]***************)
type TFGLine2DPtr     = ^TFGLine2D;
     TFGLine2D        = array [1..2] of TFGPoint2D;
     TFGLine2DArray   = array of TFGLine2D;

type TFGLine3DPtr     = ^TFGLine3D;
     TFGLine3D        = array [1..2] of TFGPoint3D;
     TFGLine3DArray   = array of TFGLine3D;


(**************[  Circle type   ]***************)
type TFGCirclePtr     = ^TFGCircle;
     TFGCircle        = record x,y,Radius : TFloat; end;
     TFGCircleArray   = array of TFGCircle;


(**************[  Sphere type   ]***************)
type TFGSpherePtr     = ^TFGSphere;
     TFGSphere        = record x,y,z,Radius : TFloat; end;
     TFGSphereArray   = array of TFGSphere;


(**************[  Arc type   ]***************)
type TFGCircularArc2DPtr = ^TFGCircularArc2D;
     TFGCircularArc2D    = record
                           x1,y1,x2,y2,cx,cy,px,py : TFloat;
                           angle1, angle2          : TFloat;
                           Orientation             : Integer;
                         end;
     TFGCircularArc2DArray = array of TFGCircularArc2D;


(************[  Bezier type   ]*************)
type TFGQuadraticBezier2DPtr   = ^TFGQuadraticBezier2D;
     TFGQuadraticBezier2D      = array [0..2] of TFGPoint2D;
     TFGQuadraticBezier2DArray = array of TFGQuadraticBezier2D;

     TFGQuadraticBezier3DPtr   = ^TFGQuadraticBezier3D;
     TFGQuadraticBezier3D      = array [0..2] of TFGPoint3D;
     TFGQuadraticBezier3DArray = array of TFGQuadraticBezier3D;

     TFGCubicBezier2DPtr       = ^TFGCubicBezier2D;
     TFGCubicBezier2D          = array [0..3] of TFGPoint2D;
     TFGCubicBezier2DArray     = array of TFGCubicBezier2D;

     TFGCubicBezier3DPtr       = ^TFGCubicBezier3D;
     TFGCubicBezier3D          = array [0..3] of TFGPoint3D;
     TFGCubicBezier3DArray     = array of TFGCubicBezier3D;

     TFGCurvePoint2D           = record x,y,t   : TFloat; end;
     TFGCurvePoint3D           = record x,y,z,t : TFloat; end;

     TFGCurvePoint2DArray      = array of TFGCurvePoint2D;
     TFGCurvePoint3DArray      = array of TFGCurvePoint3D;


(**************[ 2D Vector type ]***************)
type TFGVector2D      = record x,y : TFloat; end;
type TFGVector2DPtr   = ^TFGVector2D;
type TFGVector2DArray = array of TFGVector2D;


(**************[ 3D Vector type ]***************)
type TFGVector3D      = record x,y,z : TFloat; end;
type TFGVector3DPtr   = ^TFGVector3D;
type TFGVector3DArray = array of TFGVector3D;


(**********[ Polygon Vertex type  ]************)
type TFGPolygon2D     = array of TFGPoint2D;
type TFGPolygon2DPtr  = ^TFGPolygon2D;

type TFGPolyLine2D     = array of TFGPoint2D;
type TFGPolyLine2DPtr  = ^TFGPolyLine2D;

type TFGPolygon3D     = array of TFGPoint3D;
type TFGPolygon3DPtr  = ^TFGPolygon3D;

type TFGPolyhedron    = array of TFGPolygon3D;
type TFGPolyhedronPtr = ^TFGPolyhedron;


(**************[ Plane type ]******************)

type TFGPlane2D       = record a,b,c,d : TFloat; end;
type TFGPlane2DPtr    = ^TFGPlane2D;
...
type TGeometricObjectPtr = ^TGeometricObject;
     TGeometricObject = record
       case ObjectType : eGeometricObjectTypes of
         geoPoint2D           : (Point2D    : TFGPoint2D          );
         geoPoint3D           : (Point3D    : TFGPoint3D          );
         geoLine2D            : (Line2D     : TFGLine2D           );
         geoLine3D            : (Line3D     : TFGLine3D           );
         geoSegment2D         : (Segment2D  : TFGSegment2D        );
         geoSegment3D         : (Segment3D  : TFGSegment3D        );
         geoTriangle2D        : (Triangle2D : TFGTriangle2D       );
         geoTriangle3D        : (Triangle3D : TFGTriangle3D       );
         geoQuadix2D          : (Quadix2D   : TFGQuadix2D         );
         geoQuadix3D          : (Quadix3D   : TFGQuadix3D         );
         geoRectangle         : (Rectangle  : TFGRectangle        );
         geoCircle            : (Circle     : TFGCircle           );
         geoSphere            : (Sphere     : TFGSphere           );
         geoPolygon2D         : (Polygon2D  : TFGPolygon2DPtr     );
         geoPolygon3D         : (Polygon3D  : TFGPolygon3DPtr     );
         geoQuadraticBezier2D : (QBezier2D  : TFGQuadraticBezier2D);
         geoQuadraticBezier3D : (QBezier3D  : TFGQuadraticBezier3D);
         geoCubicBezier2D     : (CBezier2D  : TFGCubicBezier2D    );
         geoCubicBezier3D     : (CBezier3D  : TFGCubicBezier3D    );
         geoPolyhedron        : (Polyhedron : TFGPolyhedronPtr    );
       end;
...
function Orientation(const Point1,Point2:TFGPoint2D; const Px,Py:TFloat):Integer;                                                overload;
function Orientation(const Point1,Point2,Point3:TFGPoint2D):Integer;                                                             overload;
function Orientation(const Line:TFGLine2D; const Point:TFGPoint2D):Integer;                                                        overload;
function Orientation(const Segment:TFGSegment2D; const Point:TFGPoint2D):Integer;                                                  overload;

function Orientation(const Point1,Point2,Point3:TFGPoint3D; const Px,Py,Pz:TFloat):Integer;                                      overload;
function Orientation(const Point1,Point2,Point3,Point4:TFGPoint3D):Integer;                                                      overload;
function Orientation(const Triangle:TFGTriangle3D; const Point:TFGPoint3D):Integer;                                                overload;
...
function Signed(const Point1,Point2:TFGPoint2D; const Px,Py:TFloat):TFloat;                                                      overload;
function Signed(const Point1,Point2,Point3:TFGPoint2D):TFloat;                                                                   overload;
function Signed(const Line:TFGLine2D; const Point:TFGPoint2D):TFloat;                                                              overload;
function Signed(const Segment:TFGSegment2D; const Point:TFGPoint2D):TFloat;                                                        overload;

function Signed(const Point1,Point2,Point3:TFGPoint3D; const Px,Py,Pz:TFloat):TFloat;                                            overload;
function Signed(const Point1,Point2,Point3,Point4:TFGPoint3D):TFloat;                                                            overload;
function Signed(const Triangle:TFGTriangle3D; const Point:TFGPoint3D):TFloat;                                                      overload;
...
function Collinear(const PointA,PointB,PointC:TFGPoint2D):Boolean;                                                               overload;
function Collinear(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat):Boolean;                                                           overload;
function Collinear(const PointA,PointB,PointC:TFGPoint3D):Boolean;                                                               overload;

function RobustCollinear(const x1,y1,x2,y2,x3,y3:TFloat; const Epsilon : TFloat = Epsilon_High):Boolean;                       overload;
function RobustCollinear(const PointA,PointB,PointC:TFGPoint2D;  const Epsilon : TFloat = Epsilon_High):Boolean;                 overload;

function RobustCollinear(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; const Epsilon : TFloat = Epsilon_High):Boolean;              overload;
function RobustCollinear(const PointA,PointB,PointC:TFGPoint3D;  const Epsilon : TFloat = Epsilon_High):Boolean;                 overload;

function Coplanar(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat):Boolean;                                                   overload;
function Coplanar(const PointA,PointB,PointC,PointD:TFGPoint3D):Boolean;                                                         overload;

function IsPointCollinear(const x1,y1,x2,y2,Px,Py:TFloat;                   const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const PointA,PointB,PointC:TFGPoint2D;              const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const PointA,PointB:TFGPoint2D; const Px,Py:TFloat; const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const Segment:TFGSegment2D; const PointC:TFGPoint2D;  const Robust : Boolean = False):Boolean;           overload;
function IsPointCollinear(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:TFloat):Boolean;                                                    overload;
function IsPointCollinear(const PointA,PointB,PointC:TFGPoint3D):Boolean;                                                        overload;
function IsPointCollinear(const Segment:TFGSegment3D; const PointC:TFGPoint3D):Boolean;                                            overload;

function IsPointOnRightSide(const Px,Py,x1,y1,x2,y2:TFloat):Boolean;                                                           overload;
function IsPointOnRightSide(const x,y:TFloat; const Segment:TFGSegment2D):Boolean;                                               overload;
function IsPointOnRightSide(const Point:TFGPoint2D; const Segment:TFGSegment2D):Boolean;                                           overload;

function IsPointOnRightSide(const x,y:TFloat; const Line:TFGLine2D):Boolean;                                                     overload;
function IsPointOnRightSide(const Point:TFGPoint2D; const Line:TFGLine2D):Boolean;                                                 overload;

function IsPointOnLeftSide(const Px,Py,x1,y1,x2,y2:TFloat):Boolean;                                                            overload;
function IsPointOnLeftSide(const x,y:TFloat; const Segment:TFGSegment2D):Boolean;                                                overload;
function IsPointOnLeftSide(const Point:TFGPoint2D; const Segment:TFGSegment2D):Boolean;                                            overload;

function IsPointOnLeftSide(const x,y:TFloat; const Line:TFGLine2D):Boolean;                                                      overload;
function IsPointOnLeftSide(const Point:TFGPoint2D; const Line:TFGLine2D):Boolean;                                                  overload;
...
function Intersect(const Point1,Point2,Point3,Point4:TFGPoint2D):Boolean;                                                        overload;
function Intersect(const Segment1,Segment2:TFGSegment2D):Boolean;                                                                overload;
function Intersect(const Segment1,Segment2:TFGSegment2D; out ix, iy : TFloat):Boolean;                                           overload;

function Intersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; const fuzzy:TFloat = Zero):Boolean;                       overload;
function Intersect(const P1,P2,P3,P4:TFGPoint3D; const fuzzy:TFloat = Zero):Boolean;                                             overload;
function Intersect(const Segment1,Segment2:TFGSegment3D; const fuzzy:TFloat = Zero):Boolean;                                     overload;

function Intersect(const Segment:TFGSegment2D;   const Rectangle : TFGRectangle):Boolean;                                          overload;
function Intersect(const Segment:TFGSegment2D;   const Triangle  : TFGTriangle2D):Boolean;                                         overload;
function Intersect(const Segment:TFGSegment2D;   const Quadix    : TFGQuadix2D):Boolean;                                           overload;
function Intersect(const Segment:TFGSegment2D;   const Line      : TFGLine2D):Boolean;                                             overload;
function Intersect(const Segment:TFGSegment2D;   const Circle    : TFGCircle):Boolean;                                             overload;
function Intersect(const Segment:TFGSegment3D;   const Sphere    : TFGSphere):Boolean;                                             overload;
function Intersect(const Line:TFGLine2D;         const Triangle  : TFGTriangle2D):Boolean;                                         overload;
function Intersect(const Line:TFGLine2D;         const Quadix    : TFGQuadix2D):Boolean;                                           overload;
function Intersect(const Line:TFGLine2D;         const Circle    : TFGCircle):Boolean;                                             overload;
function Intersect(const Line:TFGLine3D;         const Triangle  : TFGTriangle3D; out IPoint: TFGPoint3D):Boolean;                   overload;
function Intersect(const Triangle:TFGTriangle2D; const Circle    : TFGCircle):Boolean;                                             overload;
function Intersect(const Triangle:TFGTriangle2D; const Rectangle : TFGRectangle):Boolean;                                          overload;
function Intersect(const Rectangle1,Rectangle2:TFGRectangle):Boolean;                                                            overload;
function Intersect(const Triangle1,Triangle2:TFGTriangle2D):Boolean;                                                             overload;
function Intersect(const Rectangle:TFGRectangle; const Circle:TFGCircle):Boolean;                                                  overload;
function Intersect(const Circle1,Circle2:TFGCircle):Boolean;                                                                     overload;
function Intersect(const Sphere1,Sphere2:TFGSphere):Boolean;                                                                     overload;
function Intersect(const Poly1,Poly2:TFGPolygon2D):Boolean;                                                                      overload;
...
function SimpleIntersect(const Point1,Point2,Point3,Point4:TFGPoint2D):Boolean;                                                  overload;
function SimpleIntersect(const Segment1,Segment2:TFGSegment2D):Boolean;                                                          overload;

function ThickSegmentIntersect(const x1,y1,x2,y2,x3,y3,x4,y4,Thickness:TFloat):Boolean;                                        overload;
function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TFGPoint2D; const Thickness:TFloat):Boolean;                    overload;
function ThickSegmentIntersect(const Segment1,Segment2:TFGSegment2D;         const Thickness:TFloat):Boolean;                    overload;

function ThickSegmentIntersect(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,        Thickness:TFloat):Boolean;                    overload;
function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TFGPoint3D; const Thickness:TFloat):Boolean;                    overload;
function ThickSegmentIntersect(const Segment1,Segment2:TFGSegment3D;         const Thickness:TFloat):Boolean;                    overload;

procedure IntersectionPoint(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out Nx,Ny:TFloat);                                           overload;
procedure IntersectionPoint(const P1,P2,P3,P4:TFGPoint2D; out Nx,Ny:TFloat);                                                     overload;
function  IntersectionPoint(const P1,P2,P3,P4:TFGPoint2D):TFGPoint2D;                                                              overload;
function  IntersectionPoint(const Segment1,Segment2:TFGSegment2D):TFGPoint2D;                                                      overload;

procedure IntersectionPoint(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,Fuzzy:TFloat; out Nx,Ny,Nz:TFloat);                      overload;
procedure IntersectionPoint(const P1,P2,P3,P4:TFGPoint3D; const Fuzzy:TFloat; out Nx,Ny,Nz:TFloat);                              overload;
function  IntersectionPoint(const P1,P2,P3,P4:TFGPoint3D; const Fuzzy:TFloat = Epsilon):TFGPoint3D;                                overload;
function  IntersectionPoint(const Segment1,Segment2:TFGSegment3D; const Fuzzy:TFloat = Epsilon):TFGPoint3D;                        overload;

function  IntersectionPoint(const Line1,Line2:TFGLine2D):TFGPoint2D;                                                               overload;
procedure IntersectionPoint(const Circle1,Circle2:TFGCircle; out Point1,Point2:TFGPoint2D);                                        overload;
procedure IntersectionPoint(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D; out ICnt:Integer; out I1,I2:TFGPoint2D);       overload;

procedure IntersectionPoint(const Line:TFGLine3D; const Triangle:TFGTriangle3D; out IPoint:TFGPoint3D);                              overload;
procedure IntersectionPoint(const x1,y1,x2,y2,Cx,Cy,Radius:TFloat; out ICnt:Integer; out Ix1,Iy1,Ix2,Iy2:TFloat);              overload;
procedure IntersectionPoint(const Segment:TFGSegment2D; const Circle:TFGCircle; out ICnt:Integer; out I1,I2:TFGPoint2D);             overload;
...
function Quadrant(const Point : TFGPoint2D):Integer;                                                                             overload;

function VertexAngle(x1,y1,x2,y2,x3,y3:TFloat):TFloat;                                                                         overload;
function VertexAngle(const Point1,Point2,Point3:TFGPoint2D):TFloat;                                                              overload;
function VertexAngle(x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat):TFloat;                                                                overload;
function VertexAngle(const Point1,Point2,Point3:TFGPoint3D):TFloat;                                                              overload;

function OrientedVertexAngle(const x1,y1,x2,y2,x3,y3:TFloat;      const Orient : Integer = Clockwise):TFloat;                  overload;
function OrientedVertexAngle(const Point1,Point2,Point3:TFGPoint2D; const Orient : Integer = Clockwise):TFloat;                  overload;

function CartesianAngle(const x,y   : TFloat  ):TFloat;                                                                        overload;
function CartesianAngle(const Point : TFGPoint2D):TFloat;                                                                        overload;

function RobustCartesianAngle(const x,y   : TFloat;  const Epsilon : TFloat = Epsilon_High):TFloat;                            overload;
function RobustCartesianAngle(const Point : TFGPoint2D;const Epsilon : TFloat = Epsilon_High):TFloat;                            overload;

function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TFGPoint2D):TFloat;                                             overload;
function SegmentIntersectAngle(const Segment1,Segment2:TFGSegment2D):TFloat;                                                     overload;
function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TFGPoint3D):TFloat;                                             overload;
function SegmentIntersectAngle(const Segment1,Segment2:TFGSegment3D):TFloat;                                                     overload;

function InPortal(const P:TFGPoint2D):Boolean;                                                                                   overload;
function InPortal(const P:TFGPoint3D):Boolean;                                                                                   overload;

function HighestPoint(const Polygon  : TFGPolygon2D):TFGPoint2D;                                                                   overload;
function HighestPoint(const Point    : array of TFGPoint2D):TFGPoint2D;                                                            overload;
function HighestPoint(const Triangle : TFGTriangle2D):TFGPoint2D;                                                                  overload;
function HighestPoint(const Triangle : TFGTriangle3D):TFGPoint3D;                                                                  overload;
function HighestPoint(const Quadix   : TFGQuadix2D):TFGPoint2D;                                                                    overload;
function HighestPoint(const Quadix   : TFGQuadix3D):TFGPoint3D;                                                                    overload;

function LowestPoint(const Polygon   : TFGPolygon2D):TFGPoint2D;                                                                   overload;
function LowestPoint(const Point     : array of TFGPoint2D):TFGPoint2D;                                                            overload;
function LowestPoint(const Triangle  : TFGTriangle2D):TFGPoint2D;                                                                  overload;
function LowestPoint(const Triangle  : TFGTriangle3D):TFGPoint3D;                                                                  overload;
function LowestPoint(const Quadix    : TFGQuadix2D):TFGPoint2D;                                                                    overload;
function LowestPoint(const Quadix    : TFGQuadix3D):TFGPoint3D;                                                                    overload;

function MostLeftPoint(const Polygon: TFGPolygon2D):TFGPoint2D;                                                                    overload;
function MostLeftPoint(const Point: array of TFGPoint2D):TFGPoint2D;                                                               overload;

function MostRightPoint(const Polygon: TFGPolygon2D):TFGPoint2D;                                                                   overload;
function MostRightPoint(const Point: array of TFGPoint2D):TFGPoint2D;                                                              overload;

function MostUpperRight(const Polygon: TFGPolygon2D):TFGPoint2D;                                                                   overload;
function MostUpperRight(const Point: array of TFGPoint2D):TFGPoint2D;                                                              overload;

function MostUpperLeft(const Polygon: TFGPolygon2D):TFGPoint2D;                                                                    overload;
function MostUpperLeft(const Point: array of TFGPoint2D):TFGPoint2D;                                                               overload;

function MostLowerRight(const Polygon: TFGPolygon2D):TFGPoint2D;                                                                   overload;
function MostLowerRight(const Point: array of TFGPoint2D):TFGPoint2D;                                                              overload;

function MostLowerLeft(const Polygon: TFGPolygon2D):TFGPoint2D;                                                                    overload;
function MostLowerLeft(const Point: array of TFGPoint2D):TFGPoint2D;                                                               overload;

function Min(const Point1,Point2:TFGPoint2D):TFGPoint2D;                                                                           overload;
function Min(const Point1,Point2:TFGPoint3D):TFGPoint3D;                                                                           overload;
function Max(const Point1,Point2:TFGPoint2D):TFGPoint2D;                                                                           overload;
function Max(const Point1,Point2:TFGPoint3D):TFGPoint3D;                                                                           overload;

function Coincident(const Point1,Point2:TFGPoint2D):Boolean;                                                                     overload;
function Coincident(const Point1,Point2:TFGPoint3D):Boolean;                                                                     overload;
function Coincident(const Segment1,Segment2:TFGSegment2D):Boolean;                                                               overload;
function Coincident(const Segment1,Segment2:TFGSegment3D):Boolean;                                                               overload;
function Coincident(const Triangle1,Triangle2:TFGTriangle2D):Boolean;                                                            overload;
function Coincident(const Triangle1,Triangle2:TFGTriangle3D):Boolean;                                                            overload;
function Coincident(const Rect1,Rect2:TFGRectangle):Boolean;                                                                     overload;
function Coincident(const Quad1,Quad2:TFGQuadix2D):Boolean;                                                                      overload;
function Coincident(const Quad1,Quad2:TFGQuadix3D):Boolean;                                                                      overload;
function Coincident(const Circle1,Circle2:TFGCircle):Boolean;                                                                    overload;
function Coincident(const Sphr1,Sphr2:TFGSphere):Boolean;                                                                        overload;
...
function Parallel(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;                  overload;
function Parallel(const Segment1,Segment2:TFGSegment2D;         const Epsilon:TFloat = Epsilon_Medium):Boolean;                  overload;
function Parallel(const Line1,Line2:TFGLine2D;                  const Epsilon:TFloat = Epsilon_Medium):Boolean;                  overload;

function Parallel(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;
function Parallel(const Point1,Point2,Point3,Point4:TFGPoint3D;       const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;
function Parallel(const Segment1,Segment2:TFGSegment3D;               const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;
function Parallel(const Line1,Line2:TFGLine3D;                        const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;

function RobustParallel(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat;       const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const Segment1,Segment2:TFGSegment2D;         const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;
function RobustParallel(const Line1,Line2:TFGLine2D;                  const Epsilon:TFloat = Epsilon_Medium):Boolean;            overload;
...
function RobustParallel(const Point1,Point2,Point3,Point4:TFGPoint3D;      const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
function RobustParallel(const Segment1,Segment2:TFGSegment3D;              const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
function RobustParallel(const Line1,Line2:TFGLine3D;                       const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;

function Perpendicular(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat;       const Epsilon:TFloat = Epsilon_Medium):Boolean;             overload;
function Perpendicular(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;             overload;
function Perpendicular(const Segment1,Segment2:TFGSegment2D;         const Epsilon:TFloat = Epsilon_Medium):Boolean;             overload;
function Perpendicular(const Line1,Line2:TFGLine2D;                  const Epsilon:TFloat = Epsilon_Medium):Boolean;             overload;
...
function Perpendicular(const Point1,Point2,Point3,Point4:TFGPoint3D;       const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
function Perpendicular(const Segment1,Segment2:TFGSegment3D;               const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
function Perpendicular(const Line1,Line2:TFGLine3D;                        const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;

function RobustPerpendicular(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat;       const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const Segment1,Segment2:TFGSegment2D;         const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
function RobustPerpendicular(const Line1,Line2:TFGLine2D;                  const Epsilon:TFloat = Epsilon_Medium):Boolean;       overload;
...
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TFGPoint3D;       const Epsilon:TFloat = Epsilon_Medium):Boolean; overload;
function RobustPerpendicular(const Segment1,Segment2:TFGSegment3D;               const Epsilon:TFloat = Epsilon_Medium):Boolean; overload;
function RobustPerpendicular(const Line1,Line2:TFGLine3D;                        const Epsilon:TFloat = Epsilon_Medium):Boolean; overload;

function LineToLineIntersect(x1,y1,x2,y2,x3,y3,x4,y4:TFloat):Boolean;                                                          overload;
function LineToLineIntersect(Line1,Line2:TFGLine2D):Boolean;                                                                     overload;

function RectangleToRectangleIntersect(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat):Boolean;                                          overload;
function RectangleToRectangleIntersect(const Rectangle1,Rectangle2:TFGRectangle):Boolean;                                        overload;

function RectangleWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat):Boolean;                                               overload;
function RectangleWithinRectangle(const Rectangle1,Rectangle2:TFGRectangle):Boolean;                                             overload;

function CircleWithinRectangle(const x,y,Radius,x1,y1,x2,y2:TFloat):Boolean;                                                   overload;
function CircleWithinRectangle(const Circle:TFGCircle; const Rectangle:TFGRectangle):Boolean;                                      overload;

function TriangleWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4,x5,y5:TFloat):Boolean;                                          overload;
function TriangleWithinRectangle(const Triangle:TFGTriangle2D; const Rectangle:TFGRectangle):Boolean;                              overload;

function SegmentWithinRectangle(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat):Boolean;                                                 overload;
function SegmentWithinRectangle(const Segment:TFGSegment2D; const Rectangle:TFGRectangle):Boolean;                                 overload;

function CircleInCircle(const Circle1,Circle2:TFGCircle):Boolean;
function IsTangent(const Segment:TFGSegment2D; const Circle:TFGCircle):Boolean;
function PointOfReflection(const Sx1,Sy1,Sx2,Sy2,P1x,P1y,P2x,P2y:TFloat; out RPx,RPy:TFloat):Boolean;                          overload;
function PointOfReflection(const Segment:TFGSegment2D; const P1,P2:TFGPoint2D; out RP:TFGPoint2D):Boolean;                           overload;

procedure Mirror(const Px,Py,x1,y1,x2,y2:TFloat;     out   Nx,Ny:TFloat);                                                      overload;
function  Mirror(const Point     : TFGPoint2D;         const Line:TFGLine2D):TFGPoint2D;                                             overload;
function  Mirror(const Segment   : TFGSegment2D;       const Line:TFGLine2D):TFGSegment2D;                                           overload;
function  Mirror(const Rectangle : TFGRectangle;       const Line:TFGLine2D):TFGRectangle;                                           overload;
function  Mirror(const Triangle  : TFGTriangle2D;      const Line:TFGLine2D):TFGTriangle2D;                                          overload;
function  Mirror(const Quadix    : TFGQuadix2D;        const Line:TFGLine2D):TFGQuadix2D;                                            overload;
function  Mirror(const Circle    : TFGCircle;          const Line:TFGLine2D):TFGCircle;                                              overload;
function  Mirror(const Obj       : TGeometricObject; const Line:TFGLine2D):TGeometricObject;                                     overload;

procedure NonSymmetricMirror(const Px,Py,x1,y1,x2,y2:TFloat; const Ratio:TFloat; out   Nx,Ny:TFloat);                          overload;
function  NonSymmetricMirror(const Point:TFGPoint2D;           const Ratio:TFloat; const Line:TFGLine2D):TFGPoint2D;                 overload;
function  NonSymmetricMirror(const Segment:TFGSegment2D;       const Ratio:TFloat; const Line:TFGLine2D):TFGSegment2D;               overload;
function  NonSymmetricMirror(const Rectangle:TFGRectangle;     const Ratio:TFloat; const Line:TFGLine2D):TFGRectangle;               overload;
function  NonSymmetricMirror(const Triangle:TFGTriangle2D;     const Ratio:TFloat; const Line:TFGLine2D):TFGTriangle2D;              overload;
function  NonSymmetricMirror(const Quadix:TFGQuadix2D;         const Ratio:TFloat; const Line:TFGLine2D):TFGQuadix2D;                overload;
function  NonSymmetricMirror(const Circle:TFGCircle;           const Ratio:TFloat; const Line:TFGLine2D):TFGCircle;                  overload;
function  NonSymmetricMirror(const Obj:TGeometricObject;     const Ratio:TFloat; const Line:TFGLine2D):TGeometricObject;         overload;

function Distance(const x1,y1,x2,y2:TFloat):TFloat;                                                                            overload;
function Distance(const Point1,Point2:TFGPoint2D):TFloat;                                                                        overload;
function Distance(const x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                                                      overload;
function Distance(const Point1,Point2:TFGPoint3D):TFloat;                                                                        overload;
function Distance(const Point:TFGPoint2D; const Segment:TFGSegment2D):TFloat;                                                      overload;
function Distance(const Point:TFGPoint2D; const Rectangle:TFGRectangle):TFloat;                                                    overload;
function Distance(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):TFloat;                                                    overload;
function Distance(const Point:TFGPoint2D; const Quadix:TFGQuadix2D):TFloat;                                                        overload;
function Distance(const Line1,Line2:TFGLine2D):TFloat;                                                                           overload;
function Distance(const Line1,Line2:TFGLine3D):TFloat;                                                                           overload;
function Distance(const Segment1,Segment2:TFGSegment2D):TFloat;                                                                  overload;
function Distance(const Segment1,Segment2:TFGSegment3D):TFloat;                                                                  overload;
function Distance(const Segment:TFGSegment2D):TFloat;                                                                            overload;
function Distance(const Segment:TFGSegment3D):TFloat;                                                                            overload;
function Distance(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D):TFloat;                                                overload;
function Distance(const Segment:TFGSegment3D; const Triangle:TFGTriangle3D):TFloat;                                                overload;
function Distance(const Segment:TFGSegment2D; const Rectangle:TFGRectangle):TFloat;                                                overload;
function Distance(const Segment:TFGSegment2D; const Circle:TFGCircle):TFloat;                                                      overload;

function Distance(const Triangle1,Triangle2:TFGTriangle2D):TFloat;                                                               overload;
function Distance(const Triangle:TFGTriangle2D; const Rectangle:TFGRectangle):TFloat;                                              overload;
function Distance(const Rectangle1,Rectangle2:TFGRectangle):TFloat;                                                              overload;
function Distance(const Triangle:TFGTriangle2D; const Circle:TFGCircle):TFloat;                                                    overload;
function Distance(const Rectangle:TFGRectangle; const Circle:TFGCircle):TFloat;                                                    overload;
function Distance(const Point : TFGPoint2D; const Circle:TFGCircle):TFloat;                                                        overload;
function Distance(const Circle1,Circle2:TFGCircle):TFloat;                                                                       overload;
function Distance(const Sphere1,Sphere2:TFGSphere):TFloat;                                                                       overload;
...
function LayDistance(const Point1,Point2:TFGPoint2D):TFloat;                                                                     overload;
function LayDistance(const x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                                                   overload;
function LayDistance(const Point1,Point2:TFGPoint3D):TFloat;                                                                     overload;
function LayDistance(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):TFloat;                                                 overload;
function LayDistance(const Point:TFGPoint2D; const Quadix:TFGQuadix2D):TFloat;                                                     overload;
function LayDistance(const Segment1,Segment2:TFGSegment2D):TFloat;                                                               overload;
function LayDistance(const Segment1,Segment2:TFGSegment3D):TFloat;                                                               overload;
function LayDistance(const Line1,Line2:TFGLine2D):TFloat;                                                                        overload;
function LayDistance(const Line1,Line2:TFGLine3D):TFloat;                                                                        overload;
function LayDistance(const Segment:TFGSegment2D):TFloat;                                                                         overload;
function LayDistance(const Segment:TFGSegment3D):TFloat;                                                                         overload;
function LayDistance(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D):TFloat;                                             overload;
function LayDistance(const Segment:TFGSegment3D; const Triangle:TFGTriangle3D):TFloat;                                             overload;

function ManhattanDistance(const x1,y1,x2,y2:TFloat):TFloat;                                                                   overload;
function ManhattanDistance(const Point1,Point2:TFGPoint2D):TFloat;                                                               overload;
function ManhattanDistance(const x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                                             overload;
function ManhattanDistance(const Point1,Point2:TFGPoint3D):TFloat;                                                               overload;
function ManhattanDistance(const Segment:TFGSegment2D):TFloat;                                                                   overload;
function ManhattanDistance(const Segment:TFGSegment3D):TFloat;                                                                   overload;
function ManhattanDistance(const Circle1,Circle2:TFGCircle):TFloat;                                                              overload;

function VectorSumDistance(const x1,y1,x2,y2:TFloat):TFloat;                                                                   overload;
function VectorSumDistance(const Point1,Point2:TFGPoint2D):TFloat;                                                               overload;
function VectorSumDistance(const x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                                             overload;
function VectorSumDistance(const Point1,Point2:TFGPoint3D):TFloat;                                                               overload;
function VectorSumDistance(const Segment:TFGSegment2D):TFloat;                                                                   overload;
function VectorSumDistance(const Segment:TFGSegment3D):TFloat;                                                                   overload;
function VectorSumDistance(const Circle1,Circle2:TFGCircle):TFloat;                                                              overload;
...
function ChebyshevDistance(const Point1,Point2:TFGPoint2D):TFloat;                                                               overload;
function ChebyshevDistance(const x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                                             overload;
function ChebyshevDistance(const Point1,Point2:TFGPoint3D):TFloat;                                                               overload;
function ChebyshevDistance(const Segment:TFGSegment2D):TFloat;                                                                   overload;
function ChebyshevDistance(const Segment:TFGSegment3D):TFloat;                                                                   overload;
function ChebyshevDistance(const Circle1,Circle2:TFGCircle):TFloat;                                                              overload;

function InverseChebyshevDistance(const x1,y1,x2,y2:TFloat):TFloat;                                                            overload;
function InverseChebyshevDistance(const Point1,Point2:TFGPoint2D):TFloat;                                                        overload;
function InverseChebyshevDistance(const x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                                      overload;
function InverseChebyshevDistance(const Point1,Point2:TFGPoint3D):TFloat;                                                        overload;
function InverseChebyshevDistance(const Segment:TFGSegment2D):TFloat;                                                            overload;
function InverseChebyshevDistance(const Segment:TFGSegment3D):TFloat;                                                            overload;
function InverseChebyshevDistance(const Circle1,Circle2:TFGCircle):TFloat;                                                       overload;
...
function TriangleType(const Point1,Point2,Point3:TFGPoint2D):eTriangletype;                                                      overload;
function TriangleType(const Point1,Point2,Point3:TFGPoint3D):eTriangletype;                                                      overload;
function TriangleType(const Triangle:TFGTriangle2D):eTriangletype;                                                               overload;
function TriangleType(const Triangle:TFGTriangle3D):eTriangletype;                                                               overload;
...
function IsEquilateralTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;                                                   overload;
function IsEquilateralTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;                                                   overload;
function IsEquilateralTriangle(const Triangle:TFGTriangle2D):Boolean;                                                            overload;
function IsEquilateralTriangle(const Triangle:TFGTriangle3D):Boolean;                                                            overload;
...
function IsIsoscelesTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;                                                     overload;
function IsIsoscelesTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;                                                     overload;
function IsIsoscelesTriangle(const Triangle:TFGTriangle2D):Boolean;                                                              overload;
function IsIsoscelesTriangle(const Triangle:TFGTriangle3D):Boolean;                                                              overload;
...
function IsRightTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;                                                         overload;
function IsRightTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;                                                         overload;
function IsRightTriangle(const Triangle:TFGTriangle2D):Boolean;                                                                  overload;
function IsRightTriangle(const Triangle:TFGTriangle3D):Boolean;                                                                  overload;
...
function IsScaleneTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;                                                       overload;
function IsScaleneTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;                                                       overload;
function IsScaleneTriangle(const Triangle:TFGTriangle2D):Boolean;                                                                overload;
function IsScaleneTriangle(const Triangle:TFGTriangle3D):Boolean;                                                                overload;
...
function IsObtuseTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;                                                        overload;
function IsObtuseTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;                                                        overload;
function IsObtuseTriangle(const Triangle:TFGTriangle2D):Boolean;                                                                 overload;
function IsObtuseTriangle(const Triangle:TFGTriangle3D):Boolean;                                                                 overload;

function TriangleEdge(const Triangle:TFGTriangle2D; const Edge:Integer):TFGSegment2D;                                              overload;
function TriangleEdge(const Triangle:TFGTriangle3D; const Edge:Integer):TFGSegment3D;                                              overload;

function RectangleEdge(const Rectangle:TFGRectangle; const Edge:Integer):TFGSegment2D;

function PointInTriangle(const Px,Py,x1,y1,x2,y2,x3,y3:TFloat):Boolean;                                                        overload;
function PointInTriangle(const x,y:TFloat; const Triangle:TFGTriangle2D):Boolean;                                                overload;
function PointInTriangle(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):Boolean;                                            overload;

function PointInCircle(const Px,Py,Cx,Cy,Radius:TFloat):Boolean;                                                               overload;
function PointInCircle(const Px,Py:TFloat; const Circle:TFGCircle):Boolean;                                                      overload;
function PointInCircle(const Point:TFGPoint2D; const Circle:TFGCircle):Boolean;                                                    overload;

function PointOnCircle(const Px,Py:TFloat; const Circle:TFGCircle):Boolean;                                                      overload;
function PointOnCircle(const Point:TFGPoint2D; const Circle:TFGCircle):Boolean;                                                    overload;

function TriangleInCircle         (const Triangle:TFGTriangle2D; const Circle:TFGCircle):Boolean;
function TriangleOutsideCircle    (const Triangle:TFGTriangle2D; const Circle:TFGCircle):Boolean;
function TriangleEncompassesCircle(const Triangle:TFGTriangle2D; const Circle:TFGCircle):Boolean;
function RectangleInCircle        (const Rectangle:TFGRectangle; const Circle:TFGCircle):Boolean;
function RectangleOutsideCircle   (const Rectangle:TFGRectangle; const Circle:TFGCircle):Boolean;
function QuadixInCircle           (const Quadix:TFGQuadix2D;     const Circle:TFGCircle):Boolean;
function QuadixOutsideCircle      (const Quadix:TFGQuadix2D;     const Circle:TFGCircle):Boolean;

function PointInThreePoinTFGCircle(const Px,Py,x1,y1,x2,y2,x3,y3:TFloat):Boolean;                                                overload;
function PointInThreePoinTFGCircle(const Point,Point1,Point2,Point3:TFGPoint2D):Boolean;                                           overload;
function PointInThreePoinTFGCircle(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):Boolean;                                    overload;

function PointInRectangle(const Px,Py:TFloat;   const x1,y1,x2,y2:TFloat):Boolean;                                             overload;
function PointInRectangle(const Point:TFGPoint2D; const x1,y1,x2,y2:TFloat):Boolean;                                             overload;
function PointInRectangle(const Px,Py:TFloat;   const Rectangle:TFGRectangle):Boolean;                                           overload;
function PointInRectangle(const Point:TFGPoint2D; const Rectangle:TFGRectangle):Boolean;                                           overload;

function PointInBox(const Px,Py,Pz:TFloat; const x1,y1,z1,x2,y2,z2:TFloat):Boolean;                                            overload;
function PointInBox(const Point:TFGPoint3D;  const x1,y1,z1,x2,y2,z2:TFloat):Boolean;                                            overload;
function PointInBox(const Px,Py,Pz:TFloat; const Box:TFGBox):Boolean;                                                            overload;
function PointInBox(const Point:TFGPoint3D;  const Box:TFGBox):Boolean;                                                            overload;

function TriangleInRectangle(const Triangle:TFGTriangle2D; const Rectangle:TFGRectangle):Boolean;
function TriangleOutsideRectangle(const Triangle:TFGTriangle2D; const Rectangle:TFGRectangle):Boolean;
function QuadixInRectangle(const Quadix:TFGQuadix2D; const Rectangle:TFGRectangle):Boolean;
function QuadixOutsideRectangle(const Quadix:TFGQuadix2D; const Rectangle:TFGRectangle):Boolean;

function PointInQuadix(const Px,Py,x1,y1,x2,y2,x3,y3,x4,y4:TFloat):Boolean;                                                    overload;
function PointInQuadix(const Point,Point1,Point2,Point3,Point4:TFGPoint2D):Boolean;                                              overload;
function PointInQuadix(const x,y:TFloat; const Quadix:TFGQuadix2D):Boolean;                                                      overload;
function PointInQuadix(const Point:TFGPoint2D; const Quadix:TFGQuadix2D):Boolean;                                                  overload;
function TriangleInQuadix(const Triangle:TFGTriangle2D; const Quadix:TFGQuadix2D):Boolean;
function TriangleOutsideQuadix(const Triangle:TFGTriangle2D; const Quadix:TFGQuadix2D):Boolean;

function PointInSphere(const x,y,z:TFloat; const Sphere:TFGSphere):Boolean;                                                      overload;
function PointInSphere(const Point3D:TFGPoint3D; const Sphere:TFGSphere):Boolean;                                                  overload;
function PointOnSphere(const Point3D:TFGPoint3D; const Sphere:TFGSphere):Boolean;                                                  overload;
function PolyhedronInSphere(const Polygon:TFGPolyhedron; const Sphere:TFGSphere):TInclusion;
...
function PointOnPerimeter(const Point:TFGPoint2D; const Rectangle : TFGRectangle):Boolean;                                         overload;
function PointOnPerimeter(const Point:TFGPoint2D; const Triangle  : TFGTriangle2D):Boolean;                                        overload;
function PointOnPerimeter(const Point:TFGPoint2D; const Quadix    : TFGQuadix2D):Boolean;                                          overload;
function PointOnPerimeter(const Point:TFGPoint2D; const Circle    : TFGCircle):Boolean;                                            overload;
function PointOnPerimeter(const Point:TFGPoint3D; const Sphere    : TFGSphere):Boolean;                                            overload;
function PointOnPerimeter(const Point:TFGPoint2D; const Polygon   : TFGPolygon2D):Boolean;                                         overload;
function PointOnPerimeter(const Point:TFGPoint2D; const Obj       : TGeometricObject):Boolean;                                   overload;
function PointOnPerimeter(const Point:TFGPoint3D; const Obj       : TGeometricObject):Boolean;                                   overload;

function PointInObject(const Point:TFGPoint2D; const Segment   : TFGSegment2D ):Boolean;                                           overload;
function PointInObject(const Point:TFGPoint2D; const Line      : TFGLine2D    ):Boolean;                                           overload;
function PointInObject(const Point:TFGPoint2D; const Rectangle : TFGRectangle ):Boolean;                                           overload;
function PointInObject(const Point:TFGPoint2D; const Triangle  : TFGTriangle2D):Boolean;                                           overload;
function PointInObject(const Point:TFGPoint2D; const Quadix    : TFGQuadix2D  ):Boolean;                                           overload;
function PointInObject(const Point:TFGPoint2D; const Circle    : TFGCircle    ):Boolean;                                           overload;
function PointInObject(const Point:TFGPoint2D; const Polygon   : TFGPolygon2D ):Boolean;                                           overload;
function PointInObject(const Point:TFGPoint2D; const Obj       : TGeometricObject):Boolean;                                      overload;

function GeometricSpan(const Point: array of TFGPoint2D):TFloat;                                                                 overload;
function GeometricSpan(const Point: array of TFGPoint3D):TFloat;                                                                 overload;

procedure CreateEquilateralTriangle(x1,y1,x2,y2:TFloat; out x3,y3:TFloat);                                                     overload;
procedure CreateEquilateralTriangle(const Point1,Point2:TFGPoint2D; out Point3:TFGPoint2D);                                        overload;
function  CreateEquilateralTriangle(const x1,y1,x2,y2:TFloat):TFGTriangle2D;                                                     overload;
function  CreateEquilateralTriangle(const Point1,Point2:TFGPoint2D):TFGTriangle2D;                                                 overload;
function  CreateEquilateralTriangle(const Cx,Cy,SideLength : TFloat) : TFGTriangle2D;                                            overload;
function  CreateEquilateralTriangle(const CenterPoint : TFGPoint2D; const SideLength : TFloat) : TFGTriangle2D;                    overload;

procedure TorricelliPoint(const x1,y1,x2,y2,x3,y3:TFloat; out Px,Py:TFloat);                                                   overload;
function  TorricelliPoint(const Point1,Point2,Point3:TFGPoint2D):TFGPoint2D;                                                       overload;
function  TorricelliPoint(const Triangle:TFGTriangle2D):TFGPoint2D;                                                                overload;

procedure Incenter(const x1,y1,x2,y2,x3,y3:TFloat; out Px,Py:TFloat);                                                          overload;
procedure Incenter(const Triangle:TFGTriangle2D; out Px,Py:TFloat);                                                              overload;
function  Incenter(const Point1,Point2,Point3:TFGPoint2D):TFGPoint2D;                                                              overload;
function  Incenter(const Triangle:TFGTriangle2D):TFGPoint2D;                                                                       overload;

procedure Circumcenter(const x1,y1,x2,y2,x3,y3:TFloat; out Px,Py:TFloat);                                                      overload;
function  Circumcenter(const Point1,Point2,Point3:TFGPoint2D):TFGPoint2D;                                                          overload;
function  Circumcenter(const Triangle:TFGTriangle2D):TFGPoint2D;                                                                   overload;

function Circumcircle(const P1,P2,P3:TFGPoint2D):TFGCircle;                                                                        overload;
function Circumcircle(const Triangle:TFGTriangle2D):TFGCircle;                                                                     overload;
function InscribedCircle(const x1,y1,x2,y2,x3,y3:TFloat):TFGCircle;                                                              overload;
function InscribedCircle(const P1,P2,P3:TFGPoint2D):TFGCircle;                                                                     overload;
function InscribedCircle(const Triangle:TFGTriangle2D):TFGCircle;                                                                  overload;
...
function ClosestPointOnSegmentFromPoint(const x1,y1,x2,y2,Px,Py:TFloat):TFGPoint2D;                                              overload;
function ClosestPointOnSegmentFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:TFloat):TFGPoint3D;                                     overload;

function ClosestPointOnSegmentFromPoint(const Segment:TFGSegment2D; const Point:TFGPoint2D):TFGPoint2D;                              overload;
function ClosestPointOnSegmentFromPoint(const Segment:TFGSegment3D; const Point:TFGPoint3D):TFGPoint3D;                              overload;

function ClosestPointOnLineFromPoint(const x1,y1,x2,y2,Px,Py:TFloat):TFGPoint2D;                                                 overload;
function ClosestPointOnLineFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:TFloat):TFGPoint3D;                                        overload;

function ClosestPointOnLineFromPoint(const Line:TFGLine2D; const Point:TFGPoint2D):TFGPoint2D;                                       overload;
function ClosestPointOnLineFromPoint(const Line:TFGLine3D; const Point:TFGPoint3D):TFGPoint3D;                                       overload;

procedure ClosestPointOnTriangleFromPoint(const x1,y1,x2,y2,x3,y3,Px,Py:TFloat; out Nx,Ny:TFloat);                             overload;
function  ClosestPointOnTriangleFromPoint(const Triangle:TFGTriangle2D;  const Px,Py:TFloat  ):TFGPoint2D;                         overload;
function  ClosestPointOnTriangleFromPoint(const Triangle:TFGTriangle2D;  const Point:TFGPoint2D):TFGPoint2D;                         overload;
function  ClosestPointOnTriangleFromPoint(const Triangle:TFGTriangle3D;  const Point:TFGPoint3D):TFGPoint3D;                         overload;

procedure ClosestPointOnRectangleFromPoint(const x1,y1,x2,y2,Px,Py:TFloat; out Nx,Ny:TFloat);                                  overload;
function  ClosestPointOnRectangleFromPoint(const Rectangle:TFGRectangle;  const Px,Py:TFloat  ):TFGPoint2D;                        overload;
function  ClosestPointOnRectangleFromPoint(const Rectangle:TFGRectangle;  const Point:TFGPoint2D):TFGPoint2D;                        overload;

function ClosestPointOnQuadixFromPoint(const Quadix:TFGQuadix2D;      const Point:TFGPoint2D):TFGPoint2D;                            overload;
function ClosestPointOnQuadixFromPoint(const Quadix:TFGQuadix3D;      const Point:TFGPoint3D):TFGPoint3D;                            overload;
function ClosestPointOnCircleFromPoint(const Circle:TFGCircle;        const Point:TFGPoint2D):TFGPoint2D;
function ClosestPointOnSphereFromPoint(const Sphere:TFGSphere;        const Point:TFGPoint3D):TFGPoint3D;
function ClosestPointOnAABBFromPoint  (const Rectangle: TFGRectangle; const Point:TFGPoint2D):TFGPoint2D;

function ClosestPointOnCircleFromSegment(const Circle:TFGCircle; Segment:TFGSegment2D):TFGPoint2D;
function ClosestPointOnSphereFromSegment(const Sphere:TFGSphere; Segment:TFGSegment3D):TFGPoint3D;

function MinimumDistanceFromPointToSegment(const Px,Py,x1,y1,x2,y2:TFloat):TFloat;                                             overload;
function MinimumDistanceFromPointToSegment(const Point:TFGPoint2D; const Segment:TFGSegment2D):TFloat;                             overload;
function MinimumDistanceFromPointToSegment(const Px,Py,Pz,x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                    overload;
function MinimumDistanceFromPointToSegment(const Point:TFGPoint3D; const Segment:TFGSegment3D):TFloat;                             overload;

function MinimumDistanceFromPointToLine(const Px,Py,x1,y1,x2,y2:TFloat):TFloat;                                                overload;
function MinimumDistanceFromPointToLine(const Point:TFGPoint2D; const Line:TFGLine2D):TFloat;                                      overload;
function MinimumDistanceFromPointToLine(const Px,Py,Pz,x1,y1,z1,x2,y2,z2:TFloat):TFloat;                                       overload;
function MinimumDistanceFromPointToLine(const Point:TFGPoint3D; const Line:TFGLine3D):TFloat;                                      overload;

function MinimumDistanceFromPointToTriangle(const Px,Py,x1,y1,x2,y2,x3,y3:TFloat):TFloat;                                      overload;
function MinimumDistanceFromPointToTriangle(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):TFloat;                          overload;

function MinimumDistanceFromPointToRectangle(const Px,Py,x1,y1,x2,y2:TFloat):TFloat;                                           overload;
function MinimumDistanceFromPointToRectangle(const Point:TFGPoint2D; const Rectangle:TFGRectangle):TFloat;                         overload;

function MinimumDistanceFromPointToPolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D): TFloat                             overload;

procedure SegmentMidPoint(const x1,y1,x2,y2:TFloat; out midx,midy:TFloat);                                                     overload;
procedure SegmentMidPoint(const Segment:TFGSegment2D; out midx,midy:TFloat);                                                     overload;
function  SegmentMidPoint(const P1,P2:TFGPoint2D):TFGPoint2D;                                                                      overload;
function  SegmentMidPoint(const Segment:TFGSegment2D):TFGPoint2D;                                                                  overload;

procedure SegmentMidPoint(const x1,y1,z1,x2,y2,z2:TFloat; out midx,midy,midz:TFloat);                                          overload;
function  SegmentMidPoint(const P1,P2:TFGPoint3D):TFGPoint3D;                                                                      overload;
function  SegmentMidPoint(const Segment:TFGSegment3D):TFGPoint3D;                                                                  overload;

procedure Centroid(const x1,y1,x2,y2:TFloat; out x,y:TFloat);                                                                  overload;
function  Centroid(const P1,P2:TFGPoint2D):TFGPoint2D;                                                                             overload;
function  Centroid(const Segment:TFGSegment2D):TFGPoint2D;                                                                         overload;
...
procedure Centroid(const Triangle:TFGTriangle2D; out x,y:TFloat);                                                                overload;
procedure Centroid(const Rectangle:TFGRectangle; out x,y:TFloat);                                                                overload;
procedure Centroid(const Quadix:TFGQuadix2D; out x,y:TFloat);                                                                    overload;
function  Centroid(const P1,P2,P3:TFGPoint2D):TFGPoint2D;                                                                          overload;
function  Centroid(const P1,P2,P3,P4:TFGPoint2D):TFGPoint2D;                                                                       overload;
function  Centroid(const Triangle:TFGTriangle2D):TFGPoint2D;                                                                       overload;
function  Centroid(const Quadix:TFGQuadix2D):TFGPoint2D;                                                                           overload;
function  Centroid(const Rectangle:TFGRectangle):TFGPoint2D;                                                                       overload;

procedure Centroid(const Polygon:TFGPolygon2D; out x,y:TFloat);                                                                  overload;
function  Centroid(const Polygon :TFGPolygon2D):TFGPoint2D;                                                                        overload;
function  Centroid(const Polygon : array of TFGPoint3D):TFGPoint3D;                                                                overload;

function PolygonSegmentIntersect(const Segment:TFGSegment2D; const Polygon: TFGPolygon2D):Boolean;
function PolygonInPolygon(const Poly1,Poly2: TFGPolygon2D):Boolean;

function PointInConvexPolygon(const Px,Py:TFloat; const Polygon:TFGPolygon2D):Boolean;                                           overload;
function PointInConvexPolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):Boolean;                                         overload;

function PointInConcavePolygon(const Px,Py:TFloat; const Polygon:TFGPolygon2D):Boolean;                                          overload;
function PointInConcavePolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):Boolean;                                        overload;

function PointOnPolygon(const Px,Py:TFloat;   const Polygon:TFGPolygon2D):Boolean;                                               overload;
function PointOnPolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):Boolean;                                               overload;

function PointInPolygon(const Px,Py:TFloat;             const Polygon:TFGPolygon2D):Boolean;                                     overload;
function PointInPolygon(const Point:TFGPoint2D;           const Polygon:TFGPolygon2D):Boolean;                                     overload;
function PointInPolygon(const Point: array of TFGPoint2D; const Polygon:TFGPolygon2D): TBooleanArray;                              overload;

function ConvexQuadix(const Quadix:TFGQuadix2D):Boolean;
function ComplexPolygon(const Polygon:TFGPolygon2D):Boolean;
function SimplePolygon(const Polygon:TFGPolygon2D):Boolean;
function ConvexPolygon(const Polygon:TFGPolygon2D):Boolean;                                                                      overload;
function ConvexPolygon(const Polygon: array of TFGPoint2D):Boolean;                                                              overload;
function ConcavePolygon(const Polygon:TFGPolygon2D):Boolean;
function ConvexPolygonOrientation(const Polygon:TFGPolygon2D):Integer;
function SimplePolygonOrientation(const Polygon:TFGPolygon2D):Integer;
function SelfIntersectingPolygon(const Polygon:TFGPolygon2D):Boolean;

function RectangularHull(const Point: array of TFGPoint2D):TFGRectangle;                                                           overload;
function RectangularHull(const Polygon:TFGPolygon2D):TFGRectangle;                                                                 overload;
function CircularHull(const Polygon:TFGPolygon2D):TFGCircle;
function SphereHull(const Polygon:array of TFGPoint3D):TFGSphere;
...
function CreateBarycentricUnit(const Triangle : TFGTriangle2D):TBarycentricUnit;                                                 overload;
...
procedure ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TFGPoint2D; out BCrd: TBarycentricTriplet);       overload;
function  ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TFGPoint2D): TBarycentricTriplet;                 overload;
...
procedure ConvertBarycentricToCartesian(const u,v,w:TFloat; BU:TBarycentricUnit; out Point:TFGPoint2D);                          overload;
function  ConvertBarycentricToCartesian(const u,v,w:TFloat; BU:TBarycentricUnit):TFGPoint2D;                                     overload;

function Clip(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out Cx1,Cy1,Cx2,Cy2:TFloat):Boolean;                                       overload;

function Clip(const Segment:TFGSegment2D; const Rect     : TFGRectangle;       out CSegment:TFGSegment2D):Boolean;                   overload;
function Clip(const Segment:TFGSegment2D; const Triangle : TFGTriangle2D;      out CSegment:TFGSegment2D):Boolean;                   overload;
function Clip(const Segment:TFGSegment2D; const Quadix   : TFGQuadix2D;        out CSegment:TFGSegment2D):Boolean;                   overload;
function Clip(const Segment:TFGSegment2D; const Circle   : TFGCircle;          out CSegment:TFGSegment2D):Boolean;                   overload;
function Clip(const Segment:TFGSegment2D; const Obj      : TGeometricObject; out CSegment:TFGSegment2D):Boolean;                   overload;
function Clip(const Rect1,Rect2 : TFGRectangle;                              out CRect : TFGRectangle):Boolean;                    overload;

function Area(const Point1,Point2,Point3:TFGPoint2D):TFloat;                                                                     overload;
function Area(const Point1,Point2,Point3:TFGPoint3D):TFloat;                                                                     overload;
function Area(const Triangle:TFGTriangle2D):TFloat;                                                                              overload;
function Area(const Triangle:TFGTriangle3D):TFloat;                                                                              overload;
function Area(const Quadix:TFGQuadix2D):TFloat;                                                                                  overload;
function Area(const Quadix:TFGQuadix3D):TFloat;                                                                                  overload;
function Area(const Rectangle:TFGRectangle):TFloat;                                                                              overload;
function Area(const Circle:TFGCircle):TFloat;                                                                                    overload;
function Area(const Polygon:TFGPolygon2D):TFloat;                                                                                overload;
function Area(const Obj:TGeometricObject):TFloat;                                                                              overload;

function Perimeter(const Triangle  : TFGTriangle2D):TFloat;                                                                      overload;
function Perimeter(const Triangle  : TFGTriangle3D):TFloat;                                                                      overload;
function Perimeter(const Quadix    : TFGQuadix2D):TFloat;                                                                        overload;
function Perimeter(const Quadix    : TFGQuadix3D):TFloat;                                                                        overload;
function Perimeter(const Rectangle : TFGRectangle):TFloat;                                                                       overload;
function Perimeter(const Circle    : TFGCircle):TFloat;                                                                          overload;
function Perimeter(const Polygon   : TFGPolygon2D):TFloat;                                                                       overload;
function Perimeter(const Obj       : TGeometricObject):TFloat;                                                                 overload;

function SemiPerimeter(const Triangle : TFGTriangle2D):TFloat;                                                                   overload;
function SemiPerimeter(const Triangle : TFGTriangle3D):TFloat;                                                                   overload;
...
function Rotate(const RotAng:TFloat; const Point:TFGPoint2D):TFGPoint2D;                                                           overload;
function Rotate(const RotAng:TFloat; const Point,OPoint:TFGPoint2D):TFGPoint2D;                                                    overload;
function Rotate(const RotAng:TFloat; const Segment  : TFGSegment2D):TFGSegment2D;                                                  overload;
function Rotate(const RotAng:TFloat; const Segment  : TFGSegment2D; const OPoint: TFGPoint2D):TFGSegment2D;                          overload;
function Rotate(const RotAng:TFloat; const Triangle : TFGTriangle2D):TFGTriangle2D;                                                overload;
function Rotate(const RotAng:TFloat; const Triangle : TFGTriangle2D; const OPoint:TFGPoint2D):TFGTriangle2D;                         overload;
function Rotate(const RotAng:TFloat; const Quadix   : TFGQuadix2D):TFGQuadix2D;                                                    overload;
function Rotate(const RotAng:TFloat; const Quadix   : TFGQuadix2D; const OPoint:TFGPoint2D):TFGQuadix2D;                             overload;
function Rotate(const RotAng:TFloat; const Polygon  : TFGPolygon2D):TFGPolygon2D;                                                  overload;
function Rotate(const RotAng:TFloat; const Polygon  : TFGPolygon2D; const OPoint:TFGPoint2D):TFGPolygon2D;                           overload;
function Rotate(const RotAng:TFloat; const Obj      : TGeometricObject):TGeometricObject;                                      overload;
function Rotate(const RotAng:TFloat; const Obj      : TGeometricObject; const OPoint: TFGPoint2D):TGeometricObject;              overload;
...
function Rotate(const Rx,Ry,Rz:TFloat; const Point:TFGPoint3D):TFGPoint3D;                                                         overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Point,OPoint:TFGPoint3D):TFGPoint3D;                                                  overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Segment  : TFGSegment3D):TFGSegment3D;                                                overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Segment  : TFGSegment3D; const OPoint: TFGPoint3D):TFGSegment3D;                        overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Triangle : TFGTriangle3D):TFGTriangle3D;                                              overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Triangle : TFGTriangle3D; const OPoint:TFGPoint3D):TFGTriangle3D;                       overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Quadix   : TFGQuadix3D):TFGQuadix3D;                                                  overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Quadix   : TFGQuadix3D; const OPoint:TFGPoint3D):TFGQuadix3D;                           overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Polygon  : TFGPolygon3D):TFGPolygon3D;                                                overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Polygon  : TFGPolygon3D; const OPoint:TFGPoint3D):TFGPolygon3D;                         overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Obj      : TGeometricObject):TGeometricObject;                                    overload;
function Rotate(const Rx,Ry,Rz:TFloat; const Obj      : TGeometricObject; const OPoint: TFGPoint3D):TGeometricObject;            overload;
...
function FastRotate(const RotAng:Integer; const Point:TFGPoint2D):TFGPoint2D;                                                      overload;
function FastRotate(const RotAng:Integer; const Point,OPoint:TFGPoint2D):TFGPoint2D;                                               overload;
function FastRotate(const RotAng:Integer; const Segment  : TFGSegment2D):TFGSegment2D;                                             overload;
function FastRotate(const RotAng:Integer; const Segment  : TFGSegment2D; const OPoint: TFGPoint2D):TFGSegment2D;                     overload;
function FastRotate(const RotAng:Integer; const Triangle : TFGTriangle2D):TFGTriangle2D;                                           overload;
function FastRotate(const RotAng:Integer; const Triangle : TFGTriangle2D; const OPoint:TFGPoint2D):TFGTriangle2D;                    overload;
function FastRotate(const RotAng:Integer; const Quadix   : TFGQuadix2D):TFGQuadix2D;                                               overload;
function FastRotate(const RotAng:Integer; const Quadix   : TFGQuadix2D; const OPoint:TFGPoint2D):TFGQuadix2D;                        overload;
function FastRotate(const RotAng:Integer; const Polygon  : TFGPolygon2D):TFGPolygon2D;                                             overload;
function FastRotate(const RotAng:Integer; const Polygon  : TFGPolygon2D; const OPoint:TFGPoint2D):TFGPolygon2D;                      overload;
function FastRotate(const RotAng:Integer; const Obj      : TGeometricObject):TGeometricObject;                                 overload;
function FastRotate(const RotAng:Integer; const Obj      : TGeometricObject; const OPoint: TFGPoint2D):TGeometricObject;         overload;
...
function FastRotate(const Rx,Ry,Rz:Integer; const Point:TFGPoint3D):TFGPoint3D;                                                    overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Point,OPoint:TFGPoint3D):TFGPoint3D;                                             overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Segment  : TFGSegment3D):TFGSegment3D;                                           overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Segment  : TFGSegment3D; const OPoint: TFGPoint3D):TFGSegment3D;                   overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle : TFGTriangle3D):TFGTriangle3D;                                         overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle : TFGTriangle3D; const OPoint:TFGPoint3D):TFGTriangle3D;                  overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Quadix   : TFGQuadix3D):TFGQuadix3D;                                             overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Quadix   : TFGQuadix3D; const OPoint:TFGPoint3D):TFGQuadix3D;                      overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Polygon  : TFGPolygon3D):TFGPolygon3D;                                           overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Polygon  : TFGPolygon3D; const OPoint:TFGPoint3D):TFGPolygon3D;                    overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Obj      : TGeometricObject):TGeometricObject;                               overload;
function FastRotate(const Rx,Ry,Rz:Integer; const Obj      : TGeometricObject; const OPoint: TFGPoint3D):TGeometricObject;       overload;

function Translate(const Dx,Dy:TFloat;   const Point     : TFGPoint2D):TFGPoint2D;                                                 overload;
function Translate(const Dx,Dy:TFloat;   const Line      : TFGLine2D):TFGLine2D;                                                   overload;
function Translate(const Dx,Dy:TFloat;   const Segment   : TFGSegment2D):TFGSegment2D;                                             overload;
function Translate(const Dx,Dy:TFloat;   const Triangle  : TFGTriangle2D):TFGTriangle2D;                                           overload;
function Translate(const Dx,Dy:TFloat;   const Quadix    : TFGQuadix2D):TFGQuadix2D;                                               overload;
function Translate(const Dx,Dy:TFloat;   const Rectangle : TFGRectangle):TFGRectangle;                                             overload;
function Translate(const Dx,Dy:TFloat;   const Circle    : TFGCircle):TFGCircle;                                                   overload;
function Translate(const Dx,Dy:TFloat;   const Polygon   : TFGPolygon2D):TFGPolygon2D;                                             overload;
function Translate(const Point:TFGPoint2D; const Polygon   : TFGPolygon2D):TFGPolygon2D;                                             overload;
function Translate(const Dx,Dy:TFloat;   const Obj       : TGeometricObject):TGeometricObject;                                 overload;

function Translate(const Delta:TFloat;   const Point     : TFGPoint2D):TFGPoint2D;                                                 overload;
function Translate(const Delta:TFloat;   const Line      : TFGLine2D):TFGLine2D;                                                   overload;
function Translate(const Delta:TFloat;   const Segment   : TFGSegment2D):TFGSegment2D;                                             overload;
function Translate(const Delta:TFloat;   const Triangle  : TFGTriangle2D):TFGTriangle2D;                                           overload;
function Translate(const Delta:TFloat;   const Quadix    : TFGQuadix2D):TFGQuadix2D;                                               overload;
function Translate(const Delta:TFloat;   const Rectangle : TFGRectangle):TFGRectangle;                                             overload;
function Translate(const Delta:TFloat;   const Circle    : TFGCircle):TFGCircle;                                                   overload;
function Translate(const Delta:TFloat;   const Polygon   : TFGPolygon2D):TFGPolygon2D;                                             overload;
function Translate(const Delta:TFloat;   const Obj       : TGeometricObject):TGeometricObject;                                 overload;

function Translate(const Dx,Dy,Dz:TFloat; const Point    : TFGPoint3D):TFGPoint3D;                                                 overload;
function Translate(const Dx,Dy,Dz:TFloat; const Line     : TFGLine3D):TFGLine3D;                                                   overload;
function Translate(const Dx,Dy,Dz:TFloat; const Segment  : TFGSegment3D):TFGSegment3D;                                             overload;
function Translate(const Dx,Dy,Dz:TFloat; const Triangle : TFGTriangle3D):TFGTriangle3D;                                           overload;
function Translate(const Dx,Dy,Dz:TFloat; const Quadix   : TFGQuadix3D):TFGQuadix3D;                                               overload;
function Translate(const Dx,Dy,Dz:TFloat; const Sphere   : TFGSphere):TFGSphere;                                                   overload;
function Translate(const Dx,Dy,Dz:TFloat; const Polygon  : TFGPolygon3D):TFGPolygon3D;                                             overload;
function Translate(const Point:TFGPoint3D;  const Polygon  : TFGPolygon3D):TFGPolygon3D;                                             overload;
function Translate(const Dx,Dy,Dz:TFloat; const Obj      : TGeometricObject):TGeometricObject;                                 overload;

function Scale(const Dx,Dy:TFloat; const Point     : TFGPoint2D):TFGPoint2D;                                                       overload;
function Scale(const Dx,Dy:TFloat; const Line      : TFGLine2D):TFGLine2D;                                                         overload;
function Scale(const Dx,Dy:TFloat; const Segment   : TFGSegment2D):TFGSegment2D;                                                   overload;
function Scale(const Dx,Dy:TFloat; const Triangle  : TFGTriangle2D):TFGTriangle2D;                                                 overload;
function Scale(const Dx,Dy:TFloat; const Quadix    : TFGQuadix2D):TFGQuadix2D;                                                     overload;
function Scale(const Dx,Dy:TFloat; const Rectangle : TFGRectangle):TFGRectangle;                                                   overload;
function Scale(const Dr   :TFloat; const Circle    : TFGCircle):TFGCircle;                                                         overload;
function Scale(const Dx,Dy:TFloat; const Polygon   : TFGPolygon2D):TFGPolygon2D;                                                   overload;
function Scale(const Dx,Dy:TFloat; const Obj       : TGeometricObject):TGeometricObject;                                       overload;

function Scale(const Dx,Dy,Dz:TFloat; const Point    : TFGPoint3D):TFGPoint3D;                                                     overload;
function Scale(const Dx,Dy,Dz:TFloat; const Line     : TFGLine3D):TFGLine3D;                                                       overload;
function Scale(const Dx,Dy,Dz:TFloat; const Segment  : TFGSegment3D):TFGSegment3D;                                                 overload;
function Scale(const Dx,Dy,Dz:TFloat; const Triangle : TFGTriangle3D):TFGTriangle3D;                                               overload;
function Scale(const Dx,Dy,Dz:TFloat; const Quadix   : TFGQuadix3D):TFGQuadix3D;                                                   overload;
function Scale(const Dr      :TFloat; const Sphere   : TFGSphere):TFGSphere;                                                       overload;
function Scale(const Dx,Dy,Dz:TFloat; const Polygon  : TFGPolygon3D):TFGPolygon3D;                                                 overload;
...
function ShearXAxis(const Shear:TFloat; const Point    : TFGPoint2D):TFGPoint2D;                                                   overload;
function ShearXAxis(const Shear:TFloat; const Segment  : TFGSegment2D):TFGSegment2D;                                               overload;
function ShearXAxis(const Shear:TFloat; const Triangle : TFGTriangle2D):TFGTriangle2D;                                             overload;
function ShearXAxis(const Shear:TFloat; const Quadix   : TFGQuadix2D):TFGQuadix2D;                                                 overload;
function ShearXAxis(const Shear:TFloat; const Polygon  : TFGPolygon2D):TFGPolygon2D;                                               overload;
...
function ShearYAxis(const Shear:TFloat; const Point    : TFGPoint2D):TFGPoint2D;                                                   overload;
function ShearYAxis(const Shear:TFloat; const Segment  : TFGSegment2D):TFGSegment2D;                                               overload;
function ShearYAxis(const Shear:TFloat; const Triangle : TFGTriangle2D):TFGTriangle2D;                                             overload;
function ShearYAxis(const Shear:TFloat; const Quadix   : TFGQuadix2D):TFGQuadix2D;                                                 overload;
function ShearYAxis(const Shear:TFloat; const Polygon  : TFGPolygon2D):TFGPolygon2D;                                               overload;
function ShearYAxis(const Shear:TFloat; const Obj      : TGeometricObject):TGeometricObject;                                   overload;

function CenterAtLocation(const Point:TFGPoint2D;       const x,y:TFloat):TFGPoint2D;                                              overload;
function CenterAtLocation(const Segment:TFGSegment2D;   const x,y:TFloat):TFGSegment2D;                                            overload;
function CenterAtLocation(const Triangle:TFGTriangle2D; const x,y:TFloat):TFGTriangle2D;                                           overload;
function CenterAtLocation(const Rectangle:TFGRectangle; const x,y:TFloat):TFGRectangle;                                            overload;
function CenterAtLocation(const Quadix:TFGQuadix2D;     const x,y:TFloat):TFGQuadix2D;                                             overload;
function CenterAtLocation(const Circle:TFGCircle;       const x,y:TFloat):TFGCircle;                                               overload;
function CenterAtLocation(const Polygon:TFGPolygon2D;   const x,y:TFloat):TFGPolygon2D;                                            overload;

function CenterAtLocation(const Point,                      CPoint:TFGPoint2D):TFGPoint2D;                                         overload;
function CenterAtLocation(const Segment:TFGSegment2D;   const CPoint:TFGPoint2D):TFGSegment2D;                                       overload;
function CenterAtLocation(const Triangle:TFGTriangle2D; const CPoint:TFGPoint2D):TFGTriangle2D;                                      overload;
function CenterAtLocation(const Rectangle:TFGRectangle; const CPoint:TFGPoint2D):TFGRectangle;                                       overload;
function CenterAtLocation(const Quadix:TFGQuadix2D;     const CPoint:TFGPoint2D):TFGQuadix2D;                                        overload;
function CenterAtLocation(const Circle:TFGCircle;       const CPoint:TFGPoint2D):TFGCircle;                                          overload;
function CenterAtLocation(const Polygon:TFGPolygon2D;   const CPoint:TFGPoint2D):TFGPolygon2D;                                       overload;

function AABB(const Segment   : TFGSegment2D   ):TFGRectangle;                                                                     overload;
function AABB(const Triangle  : TFGTriangle2D  ):TFGRectangle;                                                                     overload;
function AABB(const Rectangle : TFGRectangle   ):TFGRectangle;                                                                     overload;
function AABB(const Quadix    : TFGQuadix2D    ):TFGRectangle;                                                                     overload;
function AABB(const Circle    : TFGCircle      ):TFGRectangle;                                                                     overload;
function AABB(const Polygon   : TFGPolygon2D   ):TFGRectangle;                                                                     overload;
function AABB(const Curve     : TFGPoint2DArray):TFGRectangle;                                                                     overload;

procedure AABB(const Segment   : TFGSegment2D;    out x1,y1,x2,y2:TFloat);                                                       overload;
procedure AABB(const Triangle  : TFGTriangle2D;   out x1,y1,x2,y2:TFloat);                                                       overload;
procedure AABB(const Rectangle : TFGRectangle;    out x1,y1,x2,y2:TFloat);                                                       overload;
procedure AABB(const Quadix    : TFGQuadix2D;     out x1,y1,x2,y2:TFloat);                                                       overload;
procedure AABB(const Circle    : TFGCircle;       out x1,y1,x2,y2:TFloat);                                                       overload;
procedure AABB(const Polygon   : TFGPolygon2D;    out x1,y1,x2,y2:TFloat);                                                       overload;
procedure AABB(const Curve     : TFGPoint2DArray; out x1,y1,x2,y2:TFloat);                                                       overload;
...
function ProjectPoint(const SrcPoint,DstPoint:TFGPoint2D; const Dist:TFloat):TFGPoint2D;                                           overload;
function ProjectPoint(const SrcPoint,DstPoint:TFGPoint3D; const Dist:TFloat):TFGPoint3D;                                           overload;

function ProjectPoint(const Point:TFGPoint2D; Angle,Distance:TFloat):TFGPoint2D;                                                   overload;

function ProjectPoint0  (const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;
function ProjectPoint45 (const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;
function ProjectPoint90 (const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;
function ProjectPoint135(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;
function ProjectPoint180(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;
function ProjectPoint225(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;
function ProjectPoint270(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;
function ProjectPoint315(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;                                                overload;

function ProjectObject(const Point    : TFGPoint2D;         const Angle,Distance:TFloat):TFGPoint2D;                               overload;
function ProjectObject(const Segment  : TFGSegment2D;       const Angle,Distance:TFloat):TFGSegment2D;                             overload;
function ProjectObject(const Triangle : TFGTriangle2D;      const Angle,Distance:TFloat):TFGTriangle2D;                            overload;
function ProjectObject(const Quadix   : TFGQuadix2D;        const Angle,Distance:TFloat):TFGQuadix2D;                              overload;
function ProjectObject(const Circle   : TFGCircle;          const Angle,Distance:TFloat):TFGCircle;                                overload;
function ProjectObject(const Polygon  : TFGPolygon2D;       const Angle,Distance:TFloat):TFGPolygon2D;                             overload;
function ProjectObject(const GeoObj   : TGeometricObject; const Angle,Distance:TFloat):TGeometricObject;                       overload;

procedure CalculateBezierCoefficients(const Bezier : TFGQuadraticBezier2D; out ax,bx,ay,by:TFloat);                              overload;
procedure CalculateBezierCoefficients(const Bezier : TFGQuadraticBezier3D; out ax,bx,ay,by,az,bz:TFloat);                        overload;

procedure CalculateBezierCoefficients(const Bezier : TFGCubicBezier2D; out ax,bx,cx,ay,by,cy:TFloat);                            overload;
procedure CalculateBezierCoefficients(const Bezier : TFGCubicBezier3D; out ax,bx,cx,ay,by,cy,az,bz,cz:TFloat);                   overload;

function  PointOnBezier(const StartPoint:TFGPoint2D; const ax,bx,ay,by,T:TFloat):TFGPoint2D;                                       overload;
function  PointOnBezier(const StartPoint:TFGPoint3D; const ax,bx,ay,by,az,bz,T:TFloat):TFGPoint3D;                                 overload;

function  PointOnBezier(const StartPoint:TFGPoint2D; const ax,bx,cx,ay,by,cy,T:TFloat):TFGPoint2D;                                 overload;
function  PointOnBezier(const StartPoint:TFGPoint3D; const ax,bx,cx,ay,by,cy,az,bz,cz,T:TFloat):TFGPoint3D;                        overload;

function  CreateBezier(const Bezier:TFGQuadraticBezier2D; const PointCount:Integer):TFGPoint2DArray;                               overload;
function  CreateBezier(const Bezier:TFGQuadraticBezier3D; const PointCount:Integer):TFGPoint3DArray;                               overload;

function  CreateBezier(const Bezier:TFGCubicBezier2D; const PointCount:Integer):TFGPoint2DArray;                                   overload;
function  CreateBezier(const Bezier:TFGCubicBezier3D; const PointCount:Integer):TFGPoint3DArray;                                   overload;

function  CreateCurvePointBezier(const Bezier:TFGQuadraticBezier2D; const PointCount:Integer):TFGCurvePoint2DArray;                overload;
function  CreateCurvePointBezier(const Bezier:TFGQuadraticBezier3D; const PointCount:Integer):TFGCurvePoint3DArray;                overload;

function  CreateCurvePointBezier(const Bezier:TFGCubicBezier2D; const PointCount:Integer):TFGCurvePoint2DArray;                    overload;
function  CreateCurvePointBezier(const Bezier:TFGCubicBezier3D; const PointCount:Integer):TFGCurvePoint3DArray;                    overload;

function CurveLength(const Bezier:TFGQuadraticBezier2D; const PointCount:Integer):TFloat;                                        overload;
function CurveLength(const Bezier:TFGQuadraticBezier3D; const PointCount:Integer):TFloat;                                        overload;

function CurveLength(const Bezier:TFGCubicBezier2D; const PointCount:Integer):TFloat;                                            overload;
function CurveLength(const Bezier:TFGCubicBezier3D; const PointCount:Integer):TFloat;                                            overload;
...
function  ShortenSegment(const Segment:TFGSegment2D; const Amount:TFloat):TFGSegment2D;                                            overload;
function  ShortenSegment(const Segment:TFGSegment3D; const Amount:TFloat):TFGSegment3D;                                            overload;
...
function  LengthenSegment(const Segment:TFGSegment2D; const Amount:TFloat):TFGSegment2D;                                           overload;
function  LengthenSegment(const Segment:TFGSegment3D; const Amount:TFloat):TFGSegment3D;                                           overload;

function EquatePoint(const x,y:TFloat):TFGPoint2D;                                                                               overload;
function EquatePoint(const x,y,z:TFloat):TFGPoint3D;                                                                             overload;
function EquatePointPtr(const x,y:TFloat):TFGPoint2DPtr;                                                                         overload;
function EquatePointPtr(const x,y,z:TFloat):TFGPoint3DPtr;                                                                       overload;

procedure EquatePoint(const x,y:TFloat; out Point:TFGPoint2D);                                                                   overload;
procedure EquatePoint(const x,y,z:TFloat; out Point:TFGPoint3D);                                                                 overload;
procedure EquatePointPtr(const x,y:TFloat; out Point:TFGPoint2DPtr);                                                             overload;
procedure EquatePointPtr(const x,y,z:TFloat; out Point:TFGPoint3DPtr);                                                           overload;

function EquateCurvePoint(x,y,t:TFloat            ):TFGCurvePoint2D;                                                             overload;
function EquateCurvePoint(x,y,z,t:TFloat          ):TFGCurvePoint3D;                                                             overload;
function EquateCurvePoint(Point:TFGPoint2D; t:TFloat):TFGCurvePoint2D;                                                             overload;
function EquateCurvePoint(Point:TFGPoint3D; t:TFloat):TFGCurvePoint3D;                                                             overload;

function EquateSegment(const x1,y1,x2,y2:TFloat):TFGSegment2D;                                                                   overload;
function EquateSegment(const x1,y1,z1,x2,y2,z2:TFloat):TFGSegment3D;                                                             overload;

function EquateSegment(const Point1,Point2:TFGPoint2D):TFGSegment2D;                                                               overload;
function EquateSegment(const Point1,Point2:TFGPoint3D):TFGSegment3D;                                                               overload;

procedure EquateSegment(const x1,y1,x2,y2:TFloat; out Segment:TFGSegment2D);                                                     overload;
procedure EquateSegment(const x1,y1,z1,x2,y2,z2:TFloat; out Segment:TFGSegment3D);                                               overload;

function EquateLine(const x1,y1,x2,y2:TFloat):TFGLine2D;                                                                         overload;
function EquateLine(const x1,y1,z1,x2,y2,z2:TFloat):TFGLine3D;                                                                   overload;

function EquateLine(const Point1,Point2:TFGPoint2D):TFGLine2D;                                                                     overload;
function EquateLine(const Point1,Point2:TFGPoint3D):TFGLine3D;                                                                     overload;

procedure EquateLine(const x1,y1,x2,y2:TFloat; out Line:TFGLine2D);                                                              overload;
procedure EquateLine(const x1,y1,z1,x2,y2,z2:TFloat; out Line:TFGLine3D);                                                        overload;

function EquateQuadix(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat):TFGQuadix2D;                                                         overload;
function EquateQuadix(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat):TFGQuadix3D;                                             overload;

function EquateQuadix(const Point1,Point2,Point3,Point4:TFGPoint2D):TFGQuadix2D;                                                   overload;
function EquateQuadix(const Point1,Point2,Point3,Point4:TFGPoint3D):TFGQuadix3D;                                                   overload;

procedure EquateQuadix(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat;             out Quadix:TFGQuadix2D);                                overload;
procedure EquateQuadix(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; out Quadix:TFGQuadix3D);                                overload;

function  EquateRectangle(const x1,y1,x2,y2:TFloat):TFGRectangle;                                                                overload;
function  EquateRectangle(const Point1,Point2:TFGPoint2D):TFGRectangle;                                                            overload;
procedure EquateRectangle(const x1,y1,x2,y2:TFloat; out Rect:TFGRectangle);                                                      overload;
procedure EquateRectangle(const Point1,Point2:TFGPoint2D; out Rect:TFGRectangle);                                                  overload;

function EquateTriangle(const x1,y1,x2,y2,x3,y3:TFloat):TFGTriangle2D;                                                           overload;
function EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat):TFGTriangle3D;                                                  overload;
function EquateTriangle(const Point1,Point2,Point3:TFGPoint2D):TFGTriangle2D;                                                      overload;
function EquateTriangle(const Point1,Point2,Point3:TFGPoint3D):TFGTriangle3D;                                                      overload;

procedure EquateTriangle(const x1,y1,x2,y2,x3,y3:TFloat;          out Triangle:TFGTriangle2D);                                   overload;
procedure EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; out Triangle:TFGTriangle3D);                                   overload;
procedure EquateTriangle(const Point1,Point2,Point3: TFGPoint2D;    out Triangle:TFGTriangle2D);                                   overload;
procedure EquateTriangle(const Point1,Point2,Point3: TFGPoint3D;    out Triangle:TFGTriangle3D);                                   overload;

function  EquateCircle(const x,y,r:TFloat):TFGCircle;                                                                            overload;
function  EquateCircle(const Point:TFGPoint2D; Radius:TFloat):TFGCircle;                                                           overload;
procedure EquateCircle(const x,y,r:TFloat; out Circle:TFGCircle);                                                                overload;

function  EquateSphere(const x,y,z,r:TFloat):TFGSphere;                                                                          overload;
procedure EquateSphere(const x,y,z,r:TFloat; out Sphere:TFGSphere);                                                              overload;

function EquatePlane(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat):TFGPlane2D;                                                        overload;
function EquatePlane(const Point1,Point2,Point3:TFGPoint3D):TFGPlane2D;                                                            overload;

procedure EquatePlane(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; out Plane:TFGPlane2D);                                            overload;
procedure EquatePlane(const Point1,Point2,Point3:TFGPoint3D;     out Plane:TFGPlane2D);                                            overload;

procedure EquateBezier(const x1,y1,x2,y2,x3,y3:TFloat;          out Bezier:TFGQuadraticBezier2D);                                overload;
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; out Bezier:TFGQuadraticBezier3D);                                overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3:TFGPoint2D):TFGQuadraticBezier2D;                                                      overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3:TFGPoint3D):TFGQuadraticBezier3D;                                                      overload;

procedure EquateBezier(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat;             out Bezier:TFGCubicBezier2D);                           overload;
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; out Bezier:TFGCubicBezier3D);                           overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TFGPoint2D):TFGCubicBezier2D;                                                     overload;
function  EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TFGPoint3D):TFGCubicBezier3D;                                                     overload;

function  RectangleToQuadix(x1,y1,x2,y2:TFloat    ):TFGQuadix2D;                                                                 overload;
function  RectangleToQuadix(Point1,Point2:TFGPoint2D):TFGQuadix2D;                                                                 overload;
function  RectangleToQuadix(Rectangle:TFGRectangle  ):TFGQuadix2D;                                                                 overload;

function  TriangleToPolygon(x1,y1,x2,y2,x3,y3:TFloat):TFGPolygon2D;                                                              overload;
function  TriangleToPolygon(Triangle:TFGTriangle2D):TFGPolygon2D;                                                                  overload;
function  QuadixToPolygon(x1,y1,x2,y2,x3,y3,x4,y4:TFloat):TFGPolygon2D;                                                          overload;
function  QuadixToPolygon(Quadix:TFGQuadix2D):TFGPolygon2D;                                                                        overload;
function  CircleToPolygon(const Cx,Cy,Radius:TFloat; const PointCount:Integer):TFGPolygon2D;                                     overload;
function  CircleToPolygon(const Circle:TFGCircle;      const PointCount:Integer):TFGPolygon2D;                                     overload;

procedure SetGeometricObject(const Primitive:TFGPoint2D;    out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGPoint3D;    out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGLine2D;     out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGLine3D;     out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGSegment2D;  out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGSegment3D;  out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGTriangle2D; out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGTriangle3D; out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGQuadix2D;   out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGQuadix3D;   out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGRectangle;  out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGCircle;     out GeoObj:TGeometricObject);                                        overload;
procedure SetGeometricObject(const Primitive:TFGSphere;     out GeoObj:TGeometricObject);                                        overload;

procedure GenerateRandomPoints(const Bx1,By1,Bx2,By2:TFloat; var PointList:array of TFGPoint2D);                                 overload;
procedure GenerateRandomPoints(const Rectangle:TFGRectangle;   var PointList:array of TFGPoint2D);                                 overload;
procedure GenerateRandomPoints(const Segment:TFGSegment2D;     var PointList:array of TFGPoint2D);                                 overload;
procedure GenerateRandomPoints(const Segment:TFGSegment3D;     var PointList:array of TFGPoint3D);                                 overload;
procedure GenerateRandomPoints(const Triangle:TFGTriangle2D;   var PointList:array of TFGPoint2D);                                 overload;
procedure GenerateRandomPoints(const Triangle:TFGTriangle3D;   var PointList:array of TFGPoint3D);                                 overload;
procedure GenerateRandomPoints(const Circle:TFGCircle;         var PointList:array of TFGPoint2D);                                 overload;
procedure GenerateRandomPoints(const Quadix:TFGQuadix2D;       var PointList:array of TFGPoint2D);                                 overload;
procedure GenerateRandomPoints(const Quadix:TFGQuadix3D;       var PointList:array of TFGPoint3D);                                 overload;

procedure GenerateRandomPointsOnConvexPentagon(const Pentagon : TFGPolygon2D; var PointList : array of TFGPoint2D);
procedure GenerateRandomPointsOnConvexHexagon (const Hexagon  : TFGPolygon2D; var PointList : array of TFGPoint2D);
procedure GenerateRandomPointsOnConvexHeptagon(const Heptagon : TFGPolygon2D; var PointList : array of TFGPoint2D);
procedure GenerateRandomPointsOnConvexOctagon (const Octagon  : TFGPolygon2D; var PointList : array of TFGPoint2D);

procedure GenerateRandomTriangle(const Bx1,By1,Bx2,By2:TFloat; out Triangle : TFGTriangle2D);
procedure GenerateRandomQuadix  (const Bx1,By1,Bx2,By2:TFloat; out Quadix   : TFGQuadix2D);
procedure GenerateRandomCircle  (const Bx1,By1,Bx2,By2:TFloat; out Circle   : TFGCircle);

function Add(const Vec1,Vec2:TFGVector2D):TFGVector2D;                                                                             overload;
function Add(const Vec1,Vec2:TFGVector3D):TFGVector3D;                                                                             overload;

function Add(const Vec:TFGVector2DArray):TFGVector2D;                                                                              overload;
function Add(const Vec:TFGVector3DArray):TFGVector3D;                                                                              overload;
function Add(const Vec1,Vec2:TFGVector2DArray):TFGVector2DArray;                                                                   overload;
function Add(const Vec1,Vec2:TFGVector3DArray):TFGVector3DArray;                                                                   overload;

function Sub(const Vec1,Vec2:TFGVector2D):TFGVector2D;                                                                             overload;
function Sub(const Vec1,Vec2:TFGVector3D):TFGVector3D;                                                                             overload;
function Sub(const Vec1,Vec2:TFGVector2DArray):TFGVector2DArray;                                                                   overload;
function Sub(const Vec1,Vec2:TFGVector3DArray):TFGVector3DArray;                                                                   overload;

function Mul(const Vec1,Vec2:TFGVector2D):TFGVector3D;                                                                             overload;
function Mul(const Vec1,Vec2:TFGVector3D):TFGVector3D;                                                                             overload;
function Mul(const Vec1,Vec2:TFGVector3DArray):TFGVector3DArray;                                                                   overload;

function UnitVector(const Vec:TFGVector2D):TFGVector2D;                                                                            overload;
function UnitVector(const Vec:TFGVector3D):TFGVector3D;                                                                            overload;

function Magnitude(const Vec:TFGVector2D):TFloat;                                                                                overload;
function Magnitude(const Vec:TFGVector3D):TFloat;                                                                                overload;

function DotProduct(const Vec1,Vec2:TFGVector2D):TFloat;                                                                         overload;
function DotProduct(const Vec1,Vec2:TFGVector3D):TFloat;                                                                         overload;

function Scale(const Vec:TFGVector2D; const Factor:TFloat):TFGVector2D;                                                            overload;
function Scale(const Vec:TFGVector3D; const Factor:TFloat):TFGVector3D;                                                            overload;

function Scale(const Vec:TFGVector2DArray; const Factor:TFloat):TFGVector2DArray;                                                  overload;
function Scale(const Vec:TFGVector3DArray; const Factor:TFloat):TFGVector3DArray;                                                  overload;

function Negate(const Vec:TFGVector2D):TFGVector2D;                                                                                overload;
function Negate(const Vec:TFGVector3D):TFGVector3D;                                                                                overload;

function Negate(Vec:TFGVector2DArray):TFGVector2DArray;                                                                            overload;
function Negate(Vec:TFGVector3DArray):TFGVector3DArray;                                                                            overload;

function IsEqual(const Val1,Val2,Epsilon:TFloat):Boolean;                                                                      overload;
function IsEqual(const Point1,Point2:TFGPoint2D; const Epsilon:TFloat):Boolean;                                                  overload;
function IsEqual(const Point1,Point2:TFGPoint3D; const Epsilon:TFloat):Boolean;                                                  overload;

function IsEqual(const Val1,Val2:TFloat):Boolean;                                                                              overload;
function IsEqual(const Point1,Point2:TFGPoint2D):Boolean;                                                                        overload;
function IsEqual(const Point1,Point2:TFGPoint3D):Boolean;                                                                        overload;

function NotEqual(const Val1,Val2,Epsilon:TFloat):Boolean;                                                                     overload;
function NotEqual(const Point1,Point2:TFGPoint2D; const Epsilon:TFloat):Boolean;                                                 overload;
function NotEqual(const Point1,Point2:TFGPoint3D; const Epsilon:TFloat):Boolean;                                                 overload;

function NotEqual(const Val1,Val2:TFloat):Boolean;                                                                             overload;
function NotEqual(const Point1,Point2:TFGPoint2D):Boolean;                                                                       overload;
function NotEqual(const Point1,Point2:TFGPoint3D):Boolean;                                                                       overload;
...
function IsDegenerate(const Segment:TFGSegment2D):Boolean;                                                                       overload;
function IsDegenerate(const Line:TFGLine2D):Boolean;                                                                             overload;

function IsDegenerate(const x1,y1,z1,x2,y2,z2:TFloat):Boolean;                                                                 overload;
function IsDegenerate(const Segment:TFGSegment3D):Boolean;                                                                       overload;
function IsDegenerate(const Line:TFGLine3D):Boolean;                                                                             overload;

function IsDegenerate(const Triangle:TFGTriangle2D):Boolean;                                                                     overload;
function IsDegenerate(const Triangle:TFGTriangle3D):Boolean;                                                                     overload;

function IsDegenerate(const Quadix:TFGQuadix2D):Boolean;                                                                         overload;
function IsDegenerate(const Quadix:TFGQuadix3D):Boolean;                                                                         overload;

function IsDegenerate(const Rect:TFGRectangle):Boolean;                                                                          overload;

function IsDegenerate(const Circle:TFGCircle):Boolean;                                                                           overload;
function IsDegenerate(const Sphere:TFGSphere):Boolean;                                                                           overload;

function IsDegenerate(const Arc:TFGCircularArc2D):Boolean;                                                                       overload;
...
procedure Swap(var Point1,Point2       :TFGPoint2D);                                                                             overload;
procedure Swap(var Point1,Point2       :TFGPoint3D);                                                                             overload;
procedure Swap(var Segment1,Segment2   :TFGSegment2D);                                                                           overload;
procedure Swap(var Segment1,Segment2   :TFGSegment3D);                                                                           overload;
procedure Swap(var Line1,Line2         :TFGLine2D);                                                                              overload;
procedure Swap(var Triangle1,Triangle2 :TFGTriangle2D);                                                                          overload;
procedure Swap(var Triangle1,Triangle2 :TFGTriangle3D);                                                                          overload;
procedure Swap(var Quadix1,Quadix2     :TFGQuadix2D);                                                                            overload;
procedure Swap(var Quadix1,Quadix2     :TFGQuadix3D);                                                                            overload;
procedure Swap(var Circle1,Circle2     :TFGCircle);                                                                              overload;
procedure Swap(var Sphere1,Sphere2     :TFGSphere);                                                                              overload;
procedure Swap(var Arc1,Arc2           :TFGCircularArc2D);                                                                       overload;
...
function Orientation(const Point1,Point2:TFGPoint2D; const Px,Py:TFloat):Integer;
begin
...
function Orientation(const Point1,Point2,Point3:TFGPoint2D):Integer;
begin
...
function Orientation(const Line:TFGLine2D; const Point:TFGPoint2D):Integer;
begin
...
function Orientation(const Segment:TFGSegment2D; const Point:TFGPoint2D):Integer;
begin
...
function Orientation(const Point1,Point2,Point3:TFGPoint3D; const Px,Py,Pz:TFloat):Integer;
begin
...
function Orientation(const Point1,Point2,Point3,Point4:TFGPoint3D):Integer;
begin
...
function Orientation(const Triangle:TFGTriangle3D; const Point:TFGPoint3D):Integer;
begin
...
function Signed(const Point1,Point2:TFGPoint2D; const Px,Py:TFloat):TFloat;
begin
...
function Signed(const Point1,Point2,Point3:TFGPoint2D):TFloat;
begin
...
function Signed(const Line:TFGLine2D; const Point:TFGPoint2D):TFloat;
begin
...
function Signed(const Segment:TFGSegment2D; const Point:TFGPoint2D):TFloat;
begin
...
function Signed(const Point1,Point2,Point3:TFGPoint3D; const Px,Py,Pz:TFloat):TFloat;
begin
...
function Signed(const Point1,Point2,Point3,Point4:TFGPoint3D):TFloat;
begin
...
function Signed(const Triangle:TFGTriangle3D; const Point:TFGPoint3D):TFloat;
begin
...
function Collinear(const PointA,PointB,PointC:TFGPoint2D):Boolean;
begin
...
function Collinear(const PointA,PointB,PointC:TFGPoint3D):Boolean;
begin
...
function RobustCollinear(const PointA,PointB,PointC:TFGPoint2D; const Epsilon : TFloat = Epsilon_High):Boolean;
begin
...
function RobustCollinear(const PointA,PointB,PointC:TFGPoint3D;  const Epsilon : TFloat = Epsilon_High):Boolean;
begin
...
function Coplanar(const PointA,PointB,PointC,PointD:TFGPoint3D):Boolean;
begin
...
function IsPointCollinear(const PointA,PointB,PointC:TFGPoint2D; const Robust : Boolean = False):Boolean;
begin
 (*
...
function IsPointCollinear(const PointA,PointB:TFGPoint2D; const Px,Py:TFloat; const Robust : Boolean = False):Boolean;
begin
...
function IsPointCollinear(const Segment:TFGSegment2D; const PointC:TFGPoint2D; const Robust : Boolean = False):Boolean;
begin
...
function IsPointCollinear(const PointA,PointB,PointC:TFGPoint3D):Boolean;
begin
  (*
    This method will return true iff the pointC is collinear
    to points A and B and exists on the segment A->B or B->A
...
function IsPointCollinear(const Segment:TFGSegment3D; const PointC:TFGPoint3D):Boolean;
begin
...
function IsPointOnRightSide(const x,y:TFloat; const Segment:TFGSegment2D):Boolean;
begin
...
function IsPointOnRightSide(const Point:TFGPoint2D; const Segment:TFGSegment2D):Boolean;
begin
...
function IsPointOnRightSide(const x,y:TFloat; const Line:TFGLine2D):Boolean;
begin
...
function IsPointOnRightSide(const Point:TFGPoint2D; const Line:TFGLine2D):Boolean;
begin
...
function IsPointOnLeftSide(const x,y:TFloat; const Segment:TFGSegment2D):Boolean;
begin
...
function IsPointOnLeftSide(const Point:TFGPoint2D; const Segment:TFGSegment2D):Boolean;
begin
...
function IsPointOnLeftSide(const x,y:TFloat; const Line:TFGLine2D):Boolean;
begin
...
function IsPointOnLeftSide(const Point:TFGPoint2D; const Line:TFGLine2D):Boolean;
begin
...
function Intersect(const Point1,Point2,Point3,Point4:TFGPoint2D):Boolean;
begin
...
function Intersect(const Segment1,Segment2:TFGSegment2D):Boolean;
begin
...
function Intersect(const Segment1,Segment2:TFGSegment2D; out ix, iy : TFloat):Boolean;
begin
...
function Intersect(const P1,P2,P3,P4:TFGPoint3D; const fuzzy:TFloat = Zero):Boolean;
begin
...
function Intersect(const Segment1,Segment2:TFGSegment3D; const fuzzy:TFloat = Zero):Boolean;
begin
...
function Intersect(const Segment:TFGSegment2D; const Rectangle:TFGRectangle):Boolean;
begin
...
function Intersect(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D):Boolean;
begin
...
function Intersect(const Segment:TFGSegment2D; const Quadix:TFGQuadix2D):Boolean;
begin
...
function Intersect(const Segment:TFGSegment2D; const Line:TFGLine2D):Boolean;
begin
...
function Intersect(const Segment:TFGSegment2D; const Circle:TFGCircle):Boolean;
var
  Px : TFloat;
  Py : TFloat;
begin
...
function Intersect(const Segment:TFGSegment3D; const Sphere:TFGSphere):Boolean;
var
  A : TFloat;
  B : TFloat;
  C : TFloat;
...
function Intersect(const Line:TFGLine2D; const Triangle:TFGTriangle2D):Boolean;
var
  Or1 : Integer;
  Or2 : Integer;
begin
...
function Intersect(const Line:TFGLine2D; const Quadix:TFGQuadix2D):Boolean;
var
  Or1 : Integer;
  Or2 : Integer;
begin
...
function Intersect(const Line:TFGLine2D; const Circle:TFGCircle):Boolean;
var
  x1 : TFloat;
  y1 : TFloat;
  x2 : TFloat;
...
function Intersect(const Line:TFGLine3D; const Triangle:TFGTriangle3D; out IPoint: TFGPoint3D):Boolean;
var
  u   : TFGVector3D;
  v   : TFGVector3D;
  n   : TFGVector3D;
...
function Intersect(const Triangle:TFGTriangle2D; const Circle:TFGCircle):Boolean;
begin
...
function Intersect(const Triangle:TFGTriangle2D; const Rectangle : TFGRectangle):Boolean;
begin
...
function Intersect(const Rectangle1,Rectangle2:TFGRectangle):Boolean;
begin
...
function Intersect(const Triangle1,Triangle2:TFGTriangle2D):Boolean;
var
  i : Integer;
begin
  Result := False;
...
function Intersect(const Rectangle:TFGRectangle; const Circle:TFGCircle):Boolean;
begin
...
function Intersect(const Circle1,Circle2:TFGCircle):Boolean;
begin
...
function Intersect(const Sphere1,Sphere2:TFGSphere):Boolean;
begin
...
function Intersect(const Poly1,Poly2: TFGPolygon2D):Boolean;
var
  I            : Integer;
  J            : Integer;
...
function SimpleIntersect(const Point1,Point2,Point3,Point4:TFGPoint2D):Boolean;
begin
...
function SimpleIntersect(const Segment1,Segment2:TFGSegment2D):Boolean;
begin
...
function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TFGPoint2D; const Thickness:TFloat):Boolean;
begin
...
function ThickSegmentIntersect(const Segment1,Segment2:TFGSegment2D; const Thickness:TFloat):Boolean;
begin
...
function ThickSegmentIntersect(const Point1,Point2,Point3,Point4:TFGPoint3D; const Thickness:TFloat):Boolean;
begin
...
function ThickSegmentIntersect(const Segment1,Segment2:TFGSegment3D; const Thickness:TFloat):Boolean;
begin
  Result := ThickSegmentIntersect(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Thickness);
end;
(* End of ThickSegmentIntersect *)
...
procedure IntersectionPoint(const P1,P2,P3,P4:TFGPoint2D; out Nx,Ny:TFloat);
begin
...
function IntersectionPoint(const P1,P2,P3,P4:TFGPoint2D):TFGPoint2D;
begin
...
function IntersectionPoint(const Segment1,Segment2:TFGSegment2D):TFGPoint2D;
begin
...
procedure IntersectionPoint(const P1,P2,P3,P4:TFGPoint3D; const Fuzzy:TFloat; out Nx,Ny,Nz:TFloat);
begin
  IntersectionPoint(P1.x,P1.y,P1.z,P2.x,P2.y,P2.z,P3.x,P3.y,P3.z,P4.x,P4.y,P4.z,Fuzzy,Nx,Ny,Nz);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const P1,P2,P3,P4:TFGPoint3D; const Fuzzy:TFloat = Epsilon):TFGPoint3D;
begin
  IntersectionPoint(P1.x,P1.y,P1.z,P2.x,P2.y,P2.z,P3.x,P3.y,P3.z,P4.x,P4.y,P4.z,Fuzzy,Result.x,Result.y,Result.z);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const Segment1,Segment2:TFGSegment3D; const Fuzzy:TFloat = Epsilon):TFGPoint3D;
begin
  Result := IntersectionPoint(Segment1[1],Segment1[2],Segment2[1],Segment2[2]);
end;
(* End of IntersectionPoint *)

function IntersectionPoint(const Line1,Line2:TFGLine2D):TFGPoint2D;
var
  dx1   : TFloat;
  dx2   : TFloat;
  dx3   : TFloat;
...
procedure IntersectionPoint(const Circle1,Circle2:TFGCircle; out Point1,Point2:TFGPoint2D);
var
  Dist   : TFloat;
  A      : TFloat;
  H      : TFloat;
...
procedure IntersectionPoint(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D; out ICnt:Integer; out I1,I2:TFGPoint2D);
var
  Ix : TFloat;
  Iy : TFloat;
begin
...
procedure IntersectionPoint(const Line:TFGLine3D; const Triangle:TFGTriangle3D; out IPoint: TFGPoint3D);
var
  u   : TFGVector3D;
  v   : TFGVector3D;
  n   : TFGVector3D;
...
procedure IntersectionPoint(const Segment:TFGSegment2D; const Circle:TFGCircle; out ICnt:Integer; out I1,I2:TFGPoint2D);
begin
  IntersectionPoint(
...
function Quadrant(const Point : TFGPoint2D):Integer;
begin
...
function VertexAngle(const Point1,Point2,Point3:TFGPoint2D):TFloat;
begin
...
function VertexAngle(const Point1,Point2,Point3:TFGPoint3D):TFloat;
begin
...
function OrientedVertexAngle(const Point1,Point2,Point3:TFGPoint2D; const Orient : Integer = Clockwise):TFloat;
begin
...
function CartesianAngle(const Point : TFGPoint2D):TFloat;
begin
...
function RobustCartesianAngle(const Point : TFGPoint2D; const Epsilon : TFloat = Epsilon_High):TFloat;
begin
...
function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TFGPoint2D):TFloat;
var
  TempPoint : TFGPoint2D;
begin
  Result := -1;
...
function SegmentIntersectAngle(const Segment1,Segment2:TFGSegment2D):TFloat;
var
  TempPoint : TFGPoint2D;
begin
  Result := -1;
...
function SegmentIntersectAngle(const Point1,Point2,Point3,Point4:TFGPoint3D):TFloat;
begin
 {
...
function SegmentIntersectAngle(const Segment1,Segment2:TFGSegment3D):TFloat;
begin
 {
  This section can be completed once line intersection in 3D is complete
 }
...
function InPortal(const P:TFGPoint2D):Boolean;
begin
...
function InPortal(const P:TFGPoint3D):Boolean;
begin
...
function HighestPoint(const Polygon:TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
...
function HighestPoint(const Point: array of TFGPoint2D):TFGPoint2D;
var
  i : Integer;
begin
...
function HighestPoint(const Triangle:TFGTriangle2D):TFGPoint2D;
begin
  Result := Triangle[1];
...
function HighestPoint(const Triangle:TFGTriangle3D):TFGPoint3D;
begin
  Result := Triangle[1];
  if Triangle[2].y > Result.y then
    Result := Triangle[2];
...
function HighestPoint(const Quadix:TFGQuadix2D):TFGPoint2D;
begin
  Result := Quadix[1];
...
function HighestPoint(const Quadix:TFGQuadix3D):TFGPoint3D;
begin
  Result := Quadix[1];
  if Quadix[2].y > Result.y then
    Result := Quadix[2];
...
function LowestPoint(const Polygon: TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function LowestPoint(const Point: array of TFGPoint2D):TFGPoint2D;
var
  i : Integer;
begin
  if Length(Point) = 0 then Exit;
...
function LowestPoint(const Triangle:TFGTriangle2D):TFGPoint2D;
begin
  Result := Triangle[1];
  if Triangle[2].y < Result.y then
     Result := Triangle[2];
...
function LowestPoint(const Triangle:TFGTriangle3D):TFGPoint3D;
begin
  Result := Triangle[1];
  if Triangle[2].y < Result.y then
     Result := Triangle[2];
...
function LowestPoint(const Quadix:TFGQuadix2D):TFGPoint2D;
begin
  Result := Quadix[1];
  if Quadix[2].y < Result.y then
     Result := Quadix[2];
...
function LowestPoint(const Quadix:TFGQuadix3D):TFGPoint3D;
begin
  Result := Quadix[1];
  if Quadix[2].y < Result.y then
     Result := Quadix[2];
...
function MostLeftPoint(const Polygon: TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function MostLeftPoint(const Point: array of TFGPoint2D):TFGPoint2D;
begin
  Result := MostLeftPoint(TFGPolygon2D(@Point));
end;
(* End of Most Left Point *)


function MostRightPoint(const Polygon: TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function MostRightPoint(const Point: array of TFGPoint2D):TFGPoint2D;
begin
  Result := MostRightPoint(TFGPolygon2D(@Point));
end;
(* End of Most Right Point *)


function MostUpperRight(const Polygon: TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
   if Length(Polygon) = 0 then Exit;
...
function MostUpperRight(const Point: array of TFGPoint2D):TFGPoint2D;
begin
  Result := MostUpperRight(TFGPolygon2D(@Point));
end;
(* End of Most Upper Right *)


function MostUpperLeft(const Polygon: TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
  if Length(Polygon) = 0 then Exit;
...
function MostUpperLeft(const Point: array of TFGPoint2D):TFGPoint2D;
begin
 Result := MostUpperLeft(TFGPolygon2D(@Point));
end;
(* End of Most Upper Left *)


function MostLowerRight(const Polygon: TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
 if Length(Polygon) = 0 then Exit;
...
function MostLowerRight(const Point: array of TFGPoint2D):TFGPoint2D;
begin
 Result := MostLowerRight(TFGPolygon2D(@Point));
end;
(* End of Most Lower Right *)


function MostLowerLeft(const Polygon: TFGPolygon2D):TFGPoint2D;
var
  i : Integer;
begin
 if Length(Polygon) = 0 then Exit;
...
function MostLowerLeft(const Point: array of TFGPoint2D):TFGPoint2D;
begin
  Result := MostLowerLeft(TFGPolygon2D(@Point));
end;
(* End of Most Lower Left *)


function Min(const Point1,Point2:TFGPoint2D):TFGPoint2D;
begin
...
function Min(const Point1,Point2:TFGPoint3D):TFGPoint3D;
begin
       if Point1.x < Point2.x then Result := Point1
  else if Point2.x < Point1.x then Result := Point2
  else if Point1.y < Point2.y then Result := Point1
...
function Max(const Point1,Point2:TFGPoint2D):TFGPoint2D;
begin
       if Point1.x > Point2.x then Result := Point1
  else if Point2.x > Point1.x then Result := Point2
  else if Point1.y > Point2.y then Result := Point1
...
function Max(const Point1,Point2:TFGPoint3D):TFGPoint3D;
begin
       if Point1.x > Point2.x then Result := Point1
  else if Point2.x > Point1.x then Result := Point2
  else if Point1.y > Point2.y then Result := Point1
...
function Coincident(const Point1,Point2:TFGPoint2D):Boolean;
begin
...
function Coincident(const Point1,Point2:TFGPoint3D):Boolean;
begin
  Result := IsEqual(Point1,Point2);
end;
...
function Coincident(const Segment1,Segment2:TFGSegment2D):Boolean;
begin
...
function Coincident(const Segment1,Segment2:TFGSegment3D):Boolean;
begin
  Result := (Coincident(Segment1[1],Segment2[1]) and  Coincident(Segment1[2],Segment2[2])) or
            (Coincident(Segment1[1],Segment2[2]) and  Coincident(Segment1[2],Segment2[1]));
end;
...
function Coincident(const Triangle1,Triangle2:TFGTriangle2D):Boolean;
var
...
function Coincident(const Triangle1,Triangle2:TFGTriangle3D):Boolean;
var
  Flag  : array [1..3] of Boolean;
  Count : Integer;
  i     : Integer;
...
function Coincident(const Rect1,Rect2:TFGRectangle):Boolean;
begin
...
function Coincident(const Quad1,Quad2:TFGQuadix2D):Boolean;
var
...
function Coincident(const Quad1,Quad2:TFGQuadix3D):Boolean;
begin
...
function Coincident(const Circle1,Circle2:TFGCircle):Boolean;
begin
...
function Coincident(const Sphr1,Sphr2:TFGSphere):Boolean;
begin
...
function Parallel(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Parallel(const Segment1,Segment2:TFGSegment2D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Parallel(const Line1,Line2:TFGLine2D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Parallel(const Point1,Point2,Point3,Point4:TFGPoint3D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Parallel(const Segment1,Segment2:TFGSegment3D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
  Result:= Parallel(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Parallel *)
...
function Parallel(const Line1,Line2:TFGLine3D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
  Result:= Parallel(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Parallel *)
...
function RobustParallel(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustParallel(const Segment1,Segment2:TFGSegment2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustParallel(const Line1,Line2:TFGLine2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustParallel(const Point1,Point2,Point3,Point4:TFGPoint3D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustParallel(const Segment1,Segment2:TFGSegment3D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
  Result := RobustParallel(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Robust Parallel *)
...
function RobustParallel(const Line1,Line2:TFGLine3D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
  Result := RobustParallel(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Robust Parallel *)
...
function Perpendicular(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Perpendicular(const Segment1,Segment2:TFGSegment2D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Perpendicular(const Line1,Line2:TFGLine2D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Perpendicular(const Point1,Point2,Point3,Point4:TFGPoint3D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
...
function Perpendicular(const Segment1,Segment2:TFGSegment3D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
  Result := Perpendicular(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Perpendicular *)
...
function Perpendicular(const Line1,Line2:TFGLine3D; const Epsilon : TFloat = Epsilon_Medium):Boolean;
begin
  Result := Perpendicular(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Perpendicular *)
...
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TFGPoint2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustPerpendicular(const Segment1,Segment2:TFGSegment2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustPerpendicular(const Line1,Line2:TFGLine2D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustPerpendicular(const Point1,Point2,Point3,Point4:TFGPoint3D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
...
function RobustPerpendicular(const Segment1,Segment2:TFGSegment3D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
  Result := RobustPerpendicular(Segment1[1],Segment1[2],Segment2[1],Segment2[2],Epsilon);
end;
(* End of Robust Perpendicular *)
...
function RobustPerpendicular(const Line1,Line2:TFGLine3D; const Epsilon:TFloat = Epsilon_Medium):Boolean;
begin
  Result := RobustPerpendicular(Line1[1],Line1[2],Line2[1],Line2[2],Epsilon);
end;
(* End of Robust Perpendicular *)
...
function LineToLineIntersect(Line1,Line2:TFGLine2D):Boolean;
begin
...
function RectangleToRectangleIntersect(const Rectangle1,Rectangle2:TFGRectangle):Boolean;
begin
...
function RectangleWithinRectangle(const Rectangle1,Rectangle2:TFGRectangle):Boolean;
begin
...
function CircleWithinRectangle(const Circle:TFGCircle; const Rectangle:TFGRectangle):Boolean;
begin
...
function TriangleWithinRectangle(const Triangle:TFGTriangle2D; const Rectangle:TFGRectangle):Boolean;
begin
...
function SegmentWithinRectangle(const Segment:TFGSegment2D; const Rectangle:TFGRectangle):Boolean;
begin
...
function PointOfReflection(const Segment:TFGSegment2D; const P1,P2:TFGPoint2D; out RP:TFGPoint2D):Boolean;
begin
...
function Mirror(const Point:TFGPoint2D; const Line:TFGLine2D):TFGPoint2D;
begin
...
function Mirror(const Segment:TFGSegment2D; const Line:TFGLine2D):TFGSegment2D;
begin
...
function Mirror(const Rectangle:TFGRectangle; const Line:TFGLine2D):TFGRectangle;
begin
...
function Mirror(const Triangle:TFGTriangle2D; const Line:TFGLine2D):TFGTriangle2D;
begin
...
function Mirror(const Quadix:TFGQuadix2D; const Line:TFGLine2D):TFGQuadix2D;
begin
...
function Mirror(const Circle:TFGCircle; const Line:TFGLine2D):TFGCircle;
begin
...
function Mirror(const Obj:TGeometricObject; const Line:TFGLine2D):TGeometricObject;
begin
...
function NonSymmetricMirror(const Point:TFGPoint2D; const Ratio:TFloat; const Line:TFGLine2D):TFGPoint2D;
begin
...
function NonSymmetricMirror(const Segment:TFGSegment2D; const Ratio:TFloat; const Line:TFGLine2D):TFGSegment2D;
begin
...
function NonSymmetricMirror(const Rectangle:TFGRectangle; const Ratio:TFloat; const Line:TFGLine2D):TFGRectangle;
begin
...
function NonSymmetricMirror(const Triangle:TFGTriangle2D; const Ratio:TFloat; const Line:TFGLine2D):TFGTriangle2D;
begin
...
function NonSymmetricMirror(const Quadix:TFGQuadix2D; const Ratio:TFloat; const Line:TFGLine2D):TFGQuadix2D;
begin
...
function NonSymmetricMirror(const Circle:TFGCircle; const Ratio:TFloat; const Line:TFGLine2D):TFGCircle;
begin
  Result.Radius := Circle.Radius;
...
function NonSymmetricMirror(const Obj:TGeometricObject; const Ratio:TFloat; const Line:TFGLine2D):TGeometricObject;
begin
  Result.ObjectType := Obj.ObjectType;
  case Obj.ObjectType of
...
function Distance(const Point1,Point2:TFGPoint2D):TFloat;
begin
...
function Distance(const Point1,Point2:TFGPoint3D):TFloat;
begin
...
function Distance(const Point:TFGPoint2D; const Segment:TFGSegment2D):TFloat;
begin
...
function Distance(const Point:TFGPoint2D; const Rectangle:TFGRectangle):TFloat;
begin
...
function Distance(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):TFloat;
begin
...
function Distance(const Point:TFGPoint2D; const Quadix:TFGQuadix2D):TFloat;
begin
...
function Distance(const Line1,Line2:TFGLine2D):TFloat;
begin
...
function Distance(const Line1,Line2:TFGLine3D):TFloat;
begin
  Result := DistanceLineToLine(
...
function Distance(const Segment1,Segment2:TFGSegment2D):TFloat;
begin
...
function Distance(const Segment1,Segment2:TFGSegment3D):TFloat;
begin
  Result := DistanceSegmentToSegment(
...
function Distance(const Segment:TFGSegment2D):TFloat;
begin
...
function Distance(const Segment:TFGSegment3D):TFloat;
begin
  Result := Distance(Segment[1],Segment[2]);
end;
(* End of Distance *)
...
function Distance(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D):TFloat;
begin
...
function Distance(const Segment:TFGSegment3D; const Triangle:TFGTriangle3D):TFloat;
begin
  Result := sqrt(LayDistance(Segment,Triangle));
end;
(* End of Distance *)
...
function Distance(const Triangle1,Triangle2:TFGTriangle2D):TFloat;
var
  i : Integer;
begin
  Result := Min(
...
function Distance(const Triangle:TFGTriangle2D; const Rectangle:TFGRectangle):TFloat;
begin
...
function Distance(const Rectangle1,Rectangle2:TFGRectangle):TFloat;
var
  Rec1 : TFGRectangle;
  Rec2 : TFGRectangle;
begin
...
function Distance(const Segment:TFGSegment2D; const Rectangle:TFGRectangle):TFloat;
begin
  Result := Min(
...
function Distance(const Segment:TFGSegment2D; const Circle:TFGCircle):TFloat;
begin
...
function Distance(const Triangle : TFGTriangle2D; const Circle:TFGCircle):TFloat;
var
  Point1 : TFGPoint2D;
  Point2 : TFGPoint2D;
begin
...
function Distance(const Rectangle : TFGRectangle; const Circle:TFGCircle):TFloat;
var
  Point1 : TFGPoint2D;
  Point2 : TFGPoint2D;
begin
...
function Distance(const Point : TFGPoint2D; const Circle:TFGCircle):TFloat;
begin
...
function Distance(const Circle1,Circle2:TFGCircle):TFloat;
var
  Dist : TFloat;
begin
  Dist := Distance(Circle1.x,Circle1.y,Circle2.x,Circle2.y);
...
function Distance(const Sphere1,Sphere2:TFGSphere):TFloat;
var
  Dist : TFloat;
begin
...
function LayDistance(const Point1,Point2:TFGPoint2D):TFloat;
begin
...
function LayDistance(const Point1,Point2:TFGPoint3D):TFloat;
begin
...
function LayDistance(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):TFloat;
begin
...
function LayDistance(const Point:TFGPoint2D; const Quadix:TFGQuadix2D):TFloat;
begin
...
function LayDistance(const Segment1,Segment2:TFGSegment2D):TFloat;
begin
...
function LayDistance(const Segment1,Segment2:TFGSegment3D):TFloat;
begin
  Result := LayDistanceSegmentToSegment(
                                        Segment1[1].x,Segment1[1].y,Segment1[1].z,Segment1[2].x,Segment1[2].y,Segment1[2].z,
                                        Segment2[1].x,Segment2[1].y,Segment2[1].z,Segment2[2].x,Segment2[2].y,Segment2[2].z
...
function LayDistance(const Line1,Line2:TFGLine2D):TFloat;
begin
...
function LayDistance(const Line1,Line2:TFGLine3D):TFloat;
begin
  Result := LayDistanceLineToLine(
                                  Line1[1].x,Line1[1].y,Line1[1].z,Line1[2].x,Line1[2].y,Line1[2].z,
                                  Line2[1].x,Line2[1].y,Line2[1].z,Line2[2].x,Line2[2].y,Line2[2].z
...
function LayDistance(const Segment:TFGSegment2D):TFloat;
begin
...
function LayDistance(const Segment:TFGSegment3D):TFloat;
begin
  Result := LayDistance(Segment[1],Segment[2]);
end;
(* End of LayDistance *)
...
function LayDistance(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D):TFloat;
begin
  Result := Min(
                Min(
...
function LayDistance(const Segment:TFGSegment3D; const Triangle:TFGTriangle3D):TFloat;
begin
  Result := Min(
                Min(
                    LayDistanceSegmentToSegment(
...
function ManhattanDistance(const Point1,Point2:TFGPoint2D):TFloat;
begin
...
function ManhattanDistance(const Point1,Point2:TFGPoint3D):TFloat;
begin
...
function ManhattanDistance(const Segment:TFGSegment2D):TFloat;
begin
...
function ManhattanDistance(const Segment:TFGSegment3D):TFloat;
begin
  Result := ManhattanDistance(Segment[1],Segment[2]);
end;
(* End of ManhattanDistance *)
...
function ManhattanDistance(const Circle1,Circle2:TFGCircle):TFloat;
begin
...
function VectorSumDistance(const Point1,Point2:TFGPoint2D):TFloat;
begin
...
function VectorSumDistance(const Point1,Point2:TFGPoint3D):TFloat;
begin
...
function VectorSumDistance(const Segment:TFGSegment2D):TFloat;
begin
...
function VectorSumDistance(const Segment:TFGSegment3D):TFloat;
begin
  Result := VectorSumDistance(Segment[1],Segment[2]);
end;
(* End of VectorSumDistance *)
...
function VectorSumDistance(const Circle1,Circle2:TFGCircle):TFloat;
begin
...
function ChebyshevDistance(const Point1,Point2:TFGPoint2D):TFloat;
begin
...
function ChebyshevDistance(const Point1,Point2:TFGPoint3D):TFloat;
begin
...
function ChebyshevDistance(const Segment:TFGSegment2D):TFloat;
begin
...
function ChebyshevDistance(const Segment:TFGSegment3D):TFloat;
begin
  Result := ChebyshevDistance(Segment[1],Segment[2]);
end;
(* End of ChebyshevDistance *)
...
function ChebyshevDistance(const Circle1,Circle2:TFGCircle):TFloat;
begin
...
function InverseChebyshevDistance(const Point1,Point2:TFGPoint2D):TFloat;
begin
...
function InverseChebyshevDistance(const Point1,Point2:TFGPoint3D):TFloat;
begin
...
function InverseChebyshevDistance(const Segment:TFGSegment2D):TFloat;
begin
...
function InverseChebyshevDistance(const Segment:TFGSegment3D):TFloat;
begin
  Result := InverseChebyshevDistance(Segment[1],Segment[2]);
end;
(* End of InverseChebyshevDistance *)
...
function InverseChebyshevDistance(const Circle1,Circle2:TFGCircle):TFloat;
begin
...
function TriangleType(const Point1,Point2,Point3:TFGPoint2D):eTriangletype;
begin
...
function TriangleType(const Point1,Point2,Point3:TFGPoint3D):eTriangletype;
begin
...
function TriangleType(const Triangle:TFGTriangle2D):eTriangletype;
begin
...
function TriangleType(const Triangle:TFGTriangle3D):eTriangletype;
begin
  Result := TriangleType(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of Triangletype *)
...
function IsEquilateralTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;
begin
...
function IsEquilateralTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;
begin
...
function IsEquilateralTriangle(const Triangle:TFGTriangle2D):Boolean;
begin
...
function IsEquilateralTriangle(const Triangle:TFGTriangle3D):Boolean;
begin
  Result := IsEquilateralTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsEquilateralTriangle *)
...
function IsIsoscelesTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;
begin
...
function IsIsoscelesTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;
begin
...
function IsIsoscelesTriangle(const Triangle:TFGTriangle2D):Boolean;
begin
...
function IsIsoscelesTriangle(const Triangle:TFGTriangle3D):Boolean;
begin
  Result := IsIsoscelesTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of *)
...
function IsRightTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;
begin
...
function IsRightTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;
begin
...
function IsRightTriangle(const Triangle:TFGTriangle2D):Boolean;
begin
...
function IsRightTriangle(const Triangle:TFGTriangle3D):Boolean;
begin
  Result := IsRightTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsRightTriangle *)
...
function IsScaleneTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;
begin
...
function IsScaleneTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;
begin
...
function IsScaleneTriangle(const Triangle:TFGTriangle2D):Boolean;
begin
...
function IsScaleneTriangle(const Triangle:TFGTriangle3D):Boolean;
begin
 Result := IsScaleneTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsScaleneTriangle *)
...
function IsObtuseTriangle(const Point1,Point2,Point3:TFGPoint2D):Boolean;
begin
...
function IsObtuseTriangle(const Point1,Point2,Point3:TFGPoint3D):Boolean;
begin
...
function IsObtuseTriangle(const Triangle:TFGTriangle2D):Boolean;
begin
...
function IsObtuseTriangle(const Triangle:TFGTriangle3D):Boolean;
begin
  Result := IsObtuseTriangle(Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of IsObtuseTriangle *)
...
function TriangleEdge(const Triangle:TFGTriangle2D; const Edge:Integer):TFGSegment2D;
begin
  case Edge of
...
function TriangleEdge(const Triangle:TFGTriangle3D; const Edge:Integer):TFGSegment3D;
begin
  case Edge of
    1: Result := EquateSegment(Triangle[1],Triangle[2]);
    2: Result := EquateSegment(Triangle[2],Triangle[3]);
...
function PointInTriangle(const x,y:TFloat; const Triangle:TFGTriangle2D):Boolean;
begin
...
function PointInTriangle(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):Boolean;
begin
...
function PointInCircle(const Px,Py:TFloat; const Circle:TFGCircle):Boolean;
begin
...
function PointInCircle(const Point:TFGPoint2D; const Circle:TFGCircle):Boolean;
begin
...
function PointOnCircle(const Px,Py:TFloat; const Circle:TFGCircle):Boolean;
begin
...
function PointOnCircle(const Point:TFGPoint2D; const Circle:TFGCircle):Boolean;
begin
...
function PointInThreePoinTFGCircle(const Px,Py,x1,y1,x2,y2,x3,y3:TFloat):Boolean;
var
  a11 : TFloat;
  a12 : TFloat;
  a21 : TFloat;
...
function PointInThreePoinTFGCircle(const Point,Point1,Point2,Point3:TFGPoint2D):Boolean;
begin
  Result := PointInThreePoinTFGCircle(Point.x, Point.y,
                                    Point1.x,Point1.y,
                                    Point2.x,Point2.y,
                                    Point3.x,Point3.y);
end;
...
function PointInThreePoinTFGCircle(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):Boolean;
begin
  Result := PointInThreePoinTFGCircle(Point,Triangle[1],Triangle[2],Triangle[3]);
end;
(* End of Point In Three Point Circle *)
...
function PointInRectangle(const Point:TFGPoint2D; const x1,y1,x2,y2:TFloat):Boolean;
begin
...
function PointInRectangle(const Px,Py:TFloat; const Rectangle:TFGRectangle):Boolean;
begin
...
function PointInRectangle(const Point:TFGPoint2D; const Rectangle:TFGRectangle):Boolean;
begin
...
function PointInBox(const Point:TFGPoint3D;  const x1,y1,z1,x2,y2,z2:TFloat):Boolean;
begin
...
function PointInBox(const Px,Py,Pz:TFloat; const Box:TFGBox):Boolean;
begin
...
function PointInBox(const Point:TFGPoint3D;  const Box:TFGBox):Boolean;
begin
...
function PointInQuadix(const Point,Point1,Point2,Point3,Point4:TFGPoint2D):Boolean;
begin
...
function PointInQuadix(const x,y:TFloat; const Quadix:TFGQuadix2D):Boolean;
begin
...
function PointInQuadix(const Point:TFGPoint2D; const Quadix:TFGQuadix2D):Boolean;
begin
...
function PointInSphere(const x,y,z:TFloat; const Sphere:TFGSphere):Boolean;
begin
...
function PointInSphere(const Point3D:TFGPoint3D; const Sphere:TFGSphere):Boolean;
begin
...
function PointOnSphere(const Point3D:TFGPoint3D; const Sphere:TFGSphere):Boolean;
begin
...
function PointOnPerimeter(const Point: TFGPoint2D; const Rectangle:TFGRectangle):Boolean;
begin
...
function PointOnPerimeter(const Point: TFGPoint2D; const Triangle:TFGTriangle2D):Boolean;
begin
...
function PointOnPerimeter(const Point: TFGPoint2D; const Quadix: TFGQuadix2D):Boolean;
begin
...
function PointOnPerimeter(const Point: TFGPoint2D; const Circle: TFGCircle):Boolean;
begin
...
function PointOnPerimeter(const Point: TFGPoint3D; const Sphere: TFGSphere):Boolean;
begin
...
function PointOnPerimeter(const Point:TFGPoint2D; const Polygon : TFGPolygon2D):Boolean;
begin
...
function PointOnPerimeter(const Point: TFGPoint2D; const Obj:TGeometricObject):Boolean;
begin
  case Obj.ObjectType of
...
function PointOnPerimeter(const Point: TFGPoint3D; const Obj:TGeometricObject):Boolean;
begin
  case Obj.ObjectType of
...
function PointInObject(const Point:TFGPoint2D; const Segment:TFGSegment2D):Boolean;
begin
...
function PointInObject(const Point:TFGPoint2D; const Line:TFGLine2D):Boolean;
begin
...
function PointInObject(const Point:TFGPoint2D; const Rectangle:TFGRectangle):Boolean;
begin
...
function PointInObject(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):Boolean;
begin
...
function PointInObject(const Point:TFGPoint2D; const Quadix:TFGQuadix2D):Boolean;
begin
...
function PointInObject(const Point:TFGPoint2D; const Circle:TFGCircle):Boolean;
begin
...
function PointInObject(const Point:TFGPoint2D; const Polygon:TFGPolygon2D ):Boolean;
begin
...
function PointInObject(const Point:TFGPoint2D; const Obj : TGeometricObject):Boolean;
begin
  case Obj.ObjectType of
...
function GeometricSpan(const Point: array of TFGPoint2D):TFloat;
var
  TempDistance : TFloat;
  i            : Integer;
  j            : Integer;
...
function GeometricSpan(const Point: array of TFGPoint3D):TFloat;
var
  TempDistance : TFloat;
  i            : Integer;
  j            : Integer;
...
procedure CreateEquilateralTriangle(const Point1,Point2:TFGPoint2D; out Point3:TFGPoint2D);
begin
...
function CreateEquilateralTriangle(const x1,y1,x2,y2:TFloat):TFGTriangle2D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function CreateEquilateralTriangle(const Point1,Point2:TFGPoint2D):TFGTriangle2D;
begin
  Result[1] := Point1;
  Result[2] := Point2;
...
function CreateEquilateralTriangle(const Cx,Cy,SideLength : TFloat) : TFGTriangle2D;
begin
...
function CreateEquilateralTriangle(const CenterPoint : TFGPoint2D; const SideLength : TFloat) : TFGTriangle2D;
begin
...
function TorricelliPoint(const Point1,Point2,Point3:TFGPoint2D):TFGPoint2D;
begin
...
function TorricelliPoint(const Triangle:TFGTriangle2D):TFGPoint2D;
begin
...
procedure Incenter(const Triangle:TFGTriangle2D; out Px,Py:TFloat);
begin
...
function Incenter(const Point1,Point2,Point3:TFGPoint2D):TFGPoint2D;
begin
...
function Incenter(const Triangle:TFGTriangle2D):TFGPoint2D;
begin
...
function Circumcenter(const Point1,Point2,Point3:TFGPoint2D):TFGPoint2D;
begin
...
function Circumcenter(const Triangle:TFGTriangle2D):TFGPoint2D;
begin
...
function Circumcircle(const P1,P2,P3:TFGPoint2D):TFGCircle;
begin
...
function Circumcircle(const Triangle:TFGTriangle2D):TFGCircle;
begin
...
function InscribedCircle(const x1,y1,x2,y2,x3,y3:TFloat):TFGCircle;
var
  Perimeter : TFloat;
  Side12    : TFloat;
  Side23    : TFloat;
...
function InscribedCircle(const P1,P2,P3:TFGPoint2D):TFGCircle;
begin
...
function InscribedCircle(const Triangle:TFGTriangle2D):TFGCircle;
begin
...
function ClosestPointOnSegmentFromPoint(const x1,y1,x2,y2,Px,Py:TFloat):TFGPoint2D;
begin
...
function ClosestPointOnSegmentFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:TFloat):TFGPoint3D;
begin
...
function ClosestPointOnSegmentFromPoint(const Segment:TFGSegment2D; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function ClosestPointOnSegmentFromPoint(const Segment:TFGSegment3D; const Point:TFGPoint3D):TFGPoint3D;
begin
...
function ClosestPointOnLineFromPoint(const x1,y1,x2,y2,Px,Py:TFloat):TFGPoint2D;
begin
...
function ClosestPointOnLineFromPoint(const x1,y1,z1,x2,y2,z2,Px,Py,Pz:TFloat):TFGPoint3D;
begin
...
function ClosestPointOnLineFromPoint(const Line:TFGLine2D; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function ClosestPointOnLineFromPoint(const Line:TFGLine3D; const Point:TFGPoint3D):TFGPoint3D;
begin
...
function ClosestPointOnTriangleFromPoint(const Triangle:TFGTriangle2D; const Px,Py:TFloat):TFGPoint2D;
begin
...
function ClosestPointOnTriangleFromPoint(const Triangle:TFGTriangle2D; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function ClosestPointOnTriangleFromPoint(const Triangle:TFGTriangle3D; const Point:TFGPoint3D):TFGPoint3D;
var
  Leydist1 : TFloat;
  Leydist2 : TFloat;
  Leydist3 : TFloat;
...
function ClosestPointOnRectangleFromPoint(const Rectangle:TFGRectangle; const Px,Py:TFloat):TFGPoint2D;
begin
...
function ClosestPointOnRectangleFromPoint(const Rectangle:TFGRectangle; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function ClosestPointOnQuadixFromPoint(const Quadix:TFGQuadix2D; const Point:TFGPoint2D):TFGPoint2D;
var
  MinDist   : TFloat;
  TempDist  : TFloat;
  TempPoint : TFGPoint2D;
...
function ClosestPointOnQuadixFromPoint(const Quadix:TFGQuadix3D; const Point:TFGPoint3D):TFGPoint3D;
(*
var
  Leydist1 : TFloat;
  Leydist2 : TFloat;
...
function MinimumDistanceFromPointToSegment(const Point:TFGPoint2D; const Segment:TFGSegment2D):TFloat;
begin
...
function MinimumDistanceFromPointToSegment(const Point:TFGPoint3D; const Segment:TFGSegment3D):TFloat;
begin
...
function MinimumDistanceFromPointToLine(const Point:TFGPoint2D; const Line:TFGLine2D):TFloat;
begin
...
function MinimumDistanceFromPointToLine(const Point:TFGPoint3D; const Line:TFGLine3D):TFloat;
begin
...
function MinimumDistanceFromPointToTriangle(const Point:TFGPoint2D; const Triangle:TFGTriangle2D):TFloat;
begin
...
function MinimumDistanceFromPointToRectangle(const Point:TFGPoint2D; const Rectangle:TFGRectangle):TFloat;
begin
...
function MinimumDistanceFromPointToPolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):TFloat;
var
  i        : Integer;
  j        : Integer;
  TempDist : TFloat;
...
procedure SegmentMidPoint(const Segment:TFGSegment2D; out midx, midy:TFloat);
begin
...
function SegmentMidPoint(const P1,P2:TFGPoint2D):TFGPoint2D;
begin
...
function SegmentMidPoint(const Segment:TFGSegment2D):TFGPoint2D;
begin
...
function SegmentMidPoint(const P1,P2:TFGPoint3D):TFGPoint3D;
begin
...
function SegmentMidPoint(const Segment:TFGSegment3D):TFGPoint3D;
begin
 Result := SegmentMidPoint(Segment[1],Segment[2]);
end;
(* End of SegmentMidPoint *)
...
function Centroid(const P1,P2:TFGPoint2D):TFGPoint2D;
begin
...
function Centroid(const Segment:TFGSegment2D):TFGPoint2D;
begin
...
procedure Centroid(const Triangle:TFGTriangle2D; out x,y:TFloat);
begin
...
procedure Centroid(const Rectangle:TFGRectangle; out x,y:TFloat);
begin
...
procedure Centroid(const Quadix:TFGQuadix2D; out x,y:TFloat);
begin
...
function Centroid(const P1,P2,P3:TFGPoint2D):TFGPoint2D;
begin
...
function Centroid(const P1,P2,P3,P4:TFGPoint2D):TFGPoint2D;
begin
...
function Centroid(const Triangle:TFGTriangle2D):TFGPoint2D;
begin
...
function  Centroid(const Quadix:TFGQuadix2D):TFGPoint2D;
begin
...
function Centroid(const Rectangle:TFGRectangle):TFGPoint2D;
begin
...
procedure Centroid(const Polygon:TFGPolygon2D; out x,y:TFloat);
var
  i    : Integer;
  j    : Integer;
  asum : TFloat;
...
function Centroid(const Polygon:TFGPolygon2D): TFGPoint2D;
begin
...
function Centroid(const Polygon : array of TFGPoint3D):TFGPoint3D;
var
  TotalArea : TFloat;
  TempArea  : TFloat;
  i         : Integer;
...
function PointInConvexPolygon(const Px,Py:TFloat; const Polygon:TFGPolygon2D):Boolean;
var
  i                  : Integer;
  j                  : Integer;
...
function PointInConvexPolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):Boolean;
begin
...
function PointInConcavePolygon(const Px,Py:TFloat; const Polygon:TFGPolygon2D):Boolean;
begin
 (* to be implemented at a later date *)
  Result := False;
end;
...
function PointInConcavePolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):Boolean;
begin
...
function PointOnPolygon(const Px,Py:TFloat; const Polygon:TFGPolygon2D):Boolean;
var
  i : Integer;
  j : Integer;
begin
...
function PointOnPolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):Boolean;
begin
  Result := PointOnPolygon(Point.x,Point.y,Polygon);
end;
(* End of PointOnPolygon *)
...
function PointInPolygon(const Px,Py:TFloat; const Polygon:TFGPolygon2D):Boolean;
var
  i : Integer;
  j : Integer;
begin
...
function PointInPolygon(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):Boolean;
begin
...
function PointInPolygon(const Point: array of TFGPoint2D; const Polygon:TFGPolygon2D): TBooleanArray;
var
  i               : Integer;
  j               : Integer;
  k               : Integer;
...
function ConvexPolygon(const Polygon:TFGPolygon2D):Boolean;
var
  i                  : Integer;
  j                  : Integer;
  k                  : Integer;
...
function ConvexPolygon(const Polygon:array of TFGPoint2D):Boolean;
var
  i                  : Integer;
  j                  : Integer;
  k                  : Integer;
...
function RectangularHull(const Point:array of TFGPoint2D):TFGRectangle;
var
  MaxX : TFloat;
  MaxY : TFloat;
  MinX : TFloat;
...
function RectangularHull(const Polygon:TFGPolygon2D):TFGRectangle;
var
  MaxX : TFloat;
  MaxY : TFloat;
  MinX : TFloat;
...
function CreateBarycentricUnit(const Triangle : TFGTriangle2D):TBarycentricUnit;
begin
...
procedure ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TFGPoint2D; out BCrd: TBarycentricTriplet);
begin
...
function ConvertCartesianToBarycentric(const BU:TBarycentricUnit; const Point:TFGPoint2D): TBarycentricTriplet;
begin
...
procedure ConvertBarycentricToCartesian(const u,v,w:TFloat; BU:TBarycentricUnit; out Point:TFGPoint2D);
begin
...
function ConvertBarycentricToCartesian(const u,v,w:TFloat; BU:TBarycentricUnit):TFGPoint2D;
begin
...
function Clip(const Segment:TFGSegment2D; const Rect:TFGRectangle; out CSegment:TFGSegment2D):Boolean;
...
function Clip(const Segment:TFGSegment2D; const Triangle:TFGTriangle2D; out CSegment:TFGSegment2D):Boolean;
var
  Pos : Integer;
begin
...
function Clip(const Segment:TFGSegment2D; const Quadix:TFGQuadix2D; out CSegment:TFGSegment2D):Boolean;
var
  Pos : Integer;
begin
...
function Clip(const Segment:TFGSegment2D; const Circle:TFGCircle; out CSegment:TFGSegment2D):Boolean;
var
  Cnt : Integer;
  I1  : TFGPoint2D;
  I2  : TFGPoint2D;
...
function Clip(const Segment:TFGSegment2D; const Obj : TGeometricObject; out CSegment:TFGSegment2D):Boolean;
begin
  Result := False;
  case Obj.ObjectType of
...
function Clip(const Rect1,Rect2 : TFGRectangle; out CRect:TFGRectangle):Boolean;
...
function Area(const Point1,Point2,Point3:TFGPoint2D):TFloat;
begin
  Result := 0.5 *
                  (
...
function Area(const Point1,Point2,Point3:TFGPoint3D):TFloat;
var
  Dx1 : TFloat;
  Dx2 : TFloat;
  Dy1 : TFloat;
...
function Area(const Triangle:TFGTriangle2D):TFloat;
begin
  Result := 0.5 *
                 (
...
function Area(const Triangle:TFGTriangle3D):TFloat;
var
  Dx1 : TFloat;
  Dx2 : TFloat;
  Dy1 : TFloat;
...
function Area(const Quadix:TFGQuadix2D):TFloat;
begin
  Result := 0.5 *
                 (
...
function Area(const Quadix:TFGQuadix3D):TFloat;
begin
  Result := (
...
function Area(const Rectangle:TFGRectangle):TFloat;
begin
...
function Area(const Circle:TFGCircle):TFloat;
begin
...
function Area(const Polygon:TFGPolygon2D):TFloat;
var
  i : Integer;
  j : Integer;
begin
...
function Perimeter(const Triangle:TFGTriangle2D):TFloat;
begin
...
function Perimeter(const Triangle:TFGTriangle3D):TFloat;
begin
  Result:= Distance(Triangle[1],Triangle[2]) +
           Distance(Triangle[2],Triangle[3]) +
           Distance(Triangle[3],Triangle[1]);
...
function Perimeter(const Quadix:TFGQuadix2D):TFloat;
begin
...
function Perimeter(const Quadix:TFGQuadix3D):TFloat;
begin
  Result:= Distance(Quadix[1],Quadix[2]) +
           Distance(Quadix[2],Quadix[3]) +
           Distance(Quadix[3],Quadix[4]) +
...
function Perimeter(const Rectangle:TFGRectangle):TFloat;
begin
...
function Perimeter(const Circle:TFGCircle):TFloat;
begin
...
function Perimeter(const Polygon:TFGPolygon2D):TFloat;
var
  i : Integer;
  j : Integer;
begin
...
function SemiPerimeter(const Triangle : TFGTriangle2D):TFloat;
begin
...
function SemiPerimeter(const Triangle : TFGTriangle3D):TFloat;
begin
  Result := Perimeter(Triangle) * 0.5;
end;
(* End of Perimeter *)
...
function Rotate(const RotAng:TFloat; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function Rotate(const RotAng:TFloat; const Point,OPoint:TFGPoint2D):TFGPoint2D;
begin
...
function Rotate(const RotAng:TFloat; const Segment:TFGSegment2D):TFGSegment2D;
begin
...
function Rotate(const RotAng:TFloat; const Segment:TFGSegment2D; const OPoint:TFGPoint2D):TFGSegment2D;
begin
...
function Rotate(const RotAng:TFloat; const Triangle:TFGTriangle2D):TFGTriangle2D;
begin
...
function Rotate(const RotAng:TFloat; const Triangle:TFGTriangle2D; const OPoint:TFGPoint2D):TFGTriangle2D;
begin
...
function Rotate(const RotAng:TFloat; const Quadix:TFGQuadix2D):TFGQuadix2D;
begin
...
function Rotate(const RotAng:TFloat; const Quadix:TFGQuadix2D; const OPoint:TFGPoint2D):TFGQuadix2D;
begin
...
function Rotate(const RotAng:TFloat; const Polygon:TFGPolygon2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const RotAng:TFloat; const Polygon:TFGPolygon2D; const OPoint:TFGPoint2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const RotAng:TFloat; const Obj:TGeometricObject; const OPoint: TFGPoint2D):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Rotate(const Rx,Ry,Rz:TFloat; const Point:TFGPoint3D):TFGPoint3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Point,OPoint:TFGPoint3D):TFGPoint3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Segment:TFGSegment3D):TFGSegment3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Segment:TFGSegment3D; const OPoint:TFGPoint3D):TFGSegment3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Triangle:TFGTriangle3D):TFGTriangle3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Triangle:TFGTriangle3D; const OPoint:TFGPoint3D):TFGTriangle3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Quadix:TFGQuadix3D):TFGQuadix3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Quadix:TFGQuadix3D; const OPoint:TFGPoint3D):TFGQuadix3D;
begin
...
function Rotate(const Rx,Ry,Rz:TFloat; const Polygon:TFGPolygon3D):TFGPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const Rx,Ry,Rz:TFloat; const Polygon:TFGPolygon3D; const OPoint:TFGPoint3D):TFGPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Rotate(const Rx,Ry,Rz:TFloat; const Obj:TGeometricObject; const OPoint: TFGPoint3D):TGeometricObject;
begin
  case Obj.ObjectType of
...
function FastRotate(const RotAng:Integer; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function FastRotate(const RotAng:Integer; const Point,OPoint:TFGPoint2D):TFGPoint2D;
begin
...
function FastRotate(const RotAng:Integer; const Segment:TFGSegment2D):TFGSegment2D;
begin
...
function FastRotate(const RotAng:Integer; const Segment:TFGSegment2D; const OPoint:TFGPoint2D):TFGSegment2D;
begin
...
function FastRotate(const RotAng:Integer; const Triangle:TFGTriangle2D):TFGTriangle2D;
begin
...
function FastRotate(const RotAng:Integer; const Triangle:TFGTriangle2D; const OPoint:TFGPoint2D):TFGTriangle2D;
begin
...
function FastRotate(const RotAng:Integer; const Quadix:TFGQuadix2D):TFGQuadix2D;
begin
...
function FastRotate(const RotAng:Integer; const Quadix:TFGQuadix2D; const OPoint:TFGPoint2D):TFGQuadix2D;
begin
...
function FastRotate(const RotAng:Integer; const Polygon:TFGPolygon2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function FastRotate(const RotAng:Integer; const Polygon:TFGPolygon2D; const OPoint:TFGPoint2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function FastRotate(const RotAng:Integer; const Obj:TGeometricObject; const OPoint: TFGPoint2D):TGeometricObject;
begin
  case Obj.ObjectType of
...
function FastRotate(const Rx,Ry,Rz:Integer; const Point:TFGPoint3D):TFGPoint3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Point,OPoint:TFGPoint3D):TFGPoint3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Segment:TFGSegment3D):TFGSegment3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Segment:TFGSegment3D; const OPoint:TFGPoint3D):TFGSegment3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle:TFGTriangle3D):TFGTriangle3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Triangle:TFGTriangle3D; const OPoint:TFGPoint3D):TFGTriangle3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Quadix:TFGQuadix3D):TFGQuadix3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Quadix:TFGQuadix3D; const OPoint:TFGPoint3D):TFGQuadix3D;
begin
...
function FastRotate(const Rx,Ry,Rz:Integer; const Polygon:TFGPolygon3D):TFGPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function FastRotate(const Rx,Ry,Rz:Integer; const Polygon:TFGPolygon3D; const OPoint:TFGPoint3D):TFGPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function FastRotate(const Rx,Ry,Rz:Integer; const Obj:TGeometricObject; const OPoint: TFGPoint3D):TGeometricObject;
begin
  case Obj.ObjectType of
...
function Translate(const Dx,Dy:TFloat; const Point:TFGPoint2D):TFGPoint2D;
begin
  Result.x := Point.x + Dx;
  Result.y := Point.y + Dy;
end;
...
function Translate(const Dx,Dy:TFloat; const Line:TFGLine2D):TFGLine2D;
begin
...
function Translate(const Dx,Dy:TFloat; const Segment:TFGSegment2D):TFGSegment2D;
begin
...
function Translate(const Dx,Dy:TFloat; const Triangle:TFGTriangle2D):TFGTriangle2D;
begin
...
function Translate(const Dx,Dy:TFloat; const Quadix:TFGQuadix2D):TFGQuadix2D;
begin
...
function Translate(const Dx,Dy:TFloat; const Rectangle:TFGRectangle):TFGRectangle;
begin
...
function Translate(const Dx,Dy:TFloat; const Circle:TFGCircle):TFGCircle;
begin
...
function Translate(const Dx,Dy:TFloat; const Polygon:TFGPolygon2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Translate(const Point:TFGPoint2D; const Polygon:TFGPolygon2D):TFGPolygon2D;
begin
...
function Translate(const Delta:TFloat; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function Translate(const Delta:TFloat; const Line:TFGLine2D):TFGLine2D;
begin
...
function Translate(const Delta:TFloat; const Segment:TFGSegment2D):TFGSegment2D;
begin
...
function Translate(const Delta:TFloat; const Triangle:TFGTriangle2D):TFGTriangle2D;
begin
...
function Translate(const Delta:TFloat; const Quadix:TFGQuadix2D):TFGQuadix2D;
begin
...
function Translate(const Delta:TFloat; const Rectangle:TFGRectangle):TFGRectangle;
begin
...
function Translate(const Delta:TFloat; const Circle:TFGCircle):TFGCircle;
begin
...
function Translate(const Delta:TFloat; const Polygon:TFGPolygon2D):TFGPolygon2D;
begin
...
function Translate(const Dx,Dy,Dz:TFloat; const Point:TFGPoint3D):TFGPoint3D;
begin
  Result.x := Point.x + Dx;
  Result.y := Point.y + Dy;
  Result.z := Point.z + Dz;
...
function Translate(const Dx,Dy,Dz:TFloat; const Line:TFGLine3D):TFGLine3D;
begin
  Result[1].x := Line[1].x + Dx;
  Result[1].y := Line[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:TFloat; const Segment:TFGSegment3D):TFGSegment3D;
begin
  Result[1].x := Segment[1].x + Dx;
  Result[1].y := Segment[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:TFloat; const Triangle:TFGTriangle3D):TFGTriangle3D;
begin
  Result[1].x := Triangle[1].x + Dx;
  Result[1].y := Triangle[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:TFloat; const Quadix:TFGQuadix3D):TFGQuadix3D;
begin
  Result[1].x := Quadix[1].x + Dx;
  Result[1].y := Quadix[1].y + Dy;
...
function Translate(const Dx,Dy,Dz:TFloat; const Sphere:TFGSphere):TFGSphere;
begin
...
function Translate(const Dx,Dy,Dz:TFloat; const Polygon:TFGPolygon3D):TFGPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Translate(const Point:TFGPoint3D; const Polygon:TFGPolygon3D):TFGPolygon3D;
begin
...
function Scale(const Dx,Dy:TFloat; const Point:TFGPoint2D):TFGPoint2D;
begin
  Result.x := Point.x * Dx;
  Result.y := Point.y * Dy;
end;
...
function Scale(const Dx,Dy:TFloat; const Line:TFGLine2D):TFGLine2D;
begin
  Result[1].x := Line[1].x * Dx;
  Result[1].y := Line[1].y * Dy;
  Result[2].x := Line[2].x * Dx;
...
function Scale(const Dx,Dy:TFloat; const Segment:TFGSegment2D):TFGSegment2D;
begin
  Result[1].x := Segment[1].x * Dx;
  Result[1].y := Segment[1].y * Dy;
...
function Scale(const Dx,Dy:TFloat; const Triangle:TFGTriangle2D):TFGTriangle2D;
begin
  Result[1].x := Triangle[1].x * Dx;
  Result[1].y := Triangle[1].y * Dy;
  Result[2].x := Triangle[2].x * Dx;
...
function Scale(const Dx,Dy:TFloat; const Quadix:TFGQuadix2D):TFGQuadix2D;
begin
  Result[1].x := Quadix[1].x * Dx;
  Result[1].y := Quadix[1].y * Dy;
  Result[2].x := Quadix[2].x * Dx;
...
function Scale(const Dx,Dy:TFloat; const Rectangle:TFGRectangle):TFGRectangle;
begin
  Result[1].x := Rectangle[1].x * Dx;
  Result[1].y := Rectangle[1].y * Dy;
  Result[2].x := Rectangle[2].x * Dx;
...
function Scale(const Dr:TFloat; const Circle:TFGCircle):TFGCircle;
begin
  Result.x      := Circle.x;
  Result.y      := Circle.y;
...
function Scale(const Dx,Dy:TFloat; const Polygon:TFGPolygon2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function Scale(const Dx,Dy,Dz:TFloat; const Point:TFGPoint3D):TFGPoint3D;
begin
  Result.x := Point.x * Dx;
  Result.y := Point.y * Dy;
  Result.z := Point.z * Dz;
...
function Scale(const Dx,Dy,Dz:TFloat; const Line:TFGLine3D):TFGLine3D;
begin
  Result[1].x := Line[1].x * Dx;
  Result[1].y := Line[1].y * Dy;
  Result[1].z := Line[1].z * Dz;
...
function Scale(const Dx,Dy,Dz:TFloat; const Segment:TFGSegment3D):TFGSegment3D;
begin
  Result[1].x := Segment[1].x * Dx;
  Result[1].y := Segment[1].y * Dy;
  Result[1].z := Segment[1].z * Dz;
...
function Scale(const Dx,Dy,Dz:TFloat; const Triangle:TFGTriangle3D):TFGTriangle3D;
begin
  Result[1].x := Triangle[1].x * Dx;
  Result[1].y := Triangle[1].y * Dy;
  Result[1].z := Triangle[1].z * Dz;
...
function Scale(const Dx,Dy,Dz:TFloat; const Quadix:TFGQuadix3D):TFGQuadix3D;
begin
  Result[1].x := Quadix[1].x * Dx;
  Result[1].y := Quadix[1].y * Dy;
  Result[1].z := Quadix[1].z * Dz;
...
function Scale(const Dr:TFloat; const Sphere:TFGSphere):TFGSphere;
begin
  Result.x      := Sphere.x;
  Result.y      := Sphere.y;
  Result.z      := Sphere.z;
...
function Scale(const Dx,Dy,Dz:TFloat; const Polygon:TFGPolygon3D):TFGPolygon3D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function ShearXAxis(const Shear:TFloat; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function ShearXAxis(const Shear:TFloat; const Segment:TFGSegment2D):TFGSegment2D;
begin
...
function ShearXAxis(const Shear:TFloat; const Triangle:TFGTriangle2D):TFGTriangle2D;
begin
...
function ShearXAxis(const Shear:TFloat; const Quadix:TFGQuadix2D):TFGQuadix2D;
begin
...
function ShearXAxis(const Shear:TFloat; const Polygon:TFGPolygon2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function ShearYAxis(const Shear:TFloat; const Point:TFGPoint2D):TFGPoint2D;
begin
...
function ShearYAxis(const Shear:TFloat; const Segment:TFGSegment2D):TFGSegment2D;
begin
...
function ShearYAxis(const Shear:TFloat; const Triangle:TFGTriangle2D):TFGTriangle2D;
begin
...
function ShearYAxis(const Shear:TFloat; const Quadix:TFGQuadix2D):TFGQuadix2D;
begin
...
function ShearYAxis(const Shear:TFloat; const Polygon:TFGPolygon2D):TFGPolygon2D;
var
  i : Integer;
begin
  SetLength(Result,Length(Polygon));
...
function CenterAtLocation(const Point:TFGPoint2D; const x,y:TFloat):TFGPoint2D;
begin
  Result.x := x;
  Result.y := y;
end;
...
function CenterAtLocation(const Segment:TFGSegment2D; const x,y:TFloat):TFGSegment2D;
var
  Cx : TFloat;
  Cy : TFloat;
begin
...
function CenterAtLocation(const Triangle:TFGTriangle2D; const x,y:TFloat):TFGTriangle2D;
var
  Cx : TFloat;
  Cy : TFloat;
begin
...
function CenterAtLocation(const Rectangle:TFGRectangle; const x,y:TFloat):TFGRectangle;
var
  Cx : TFloat;
  Cy : TFloat;
begin
...
function CenterAtLocation(const Quadix:TFGQuadix2D; const x,y:TFloat):TFGQuadix2D;
var
  Cx : TFloat;
  Cy : TFloat;
begin
...
function CenterAtLocation(const Circle:TFGCircle; const x,y:TFloat):TFGCircle;
begin
  Result.x := x;
  Result.y := y;
end;
...
function CenterAtLocation(const Polygon:TFGPolygon2D; const x,y:TFloat):TFGPolygon2D;
var
  Cx : TFloat;
  Cy : TFloat;
begin
...
function CenterAtLocation(const Point, CPoint:TFGPoint2D):TFGPoint2D;
begin
...
function CenterAtLocation(const Segment:TFGSegment2D; const CPoint:TFGPoint2D):TFGSegment2D;
begin
...
function CenterAtLocation(const Triangle:TFGTriangle2D; const CPoint:TFGPoint2D):TFGTriangle2D;
begin
...
function CenterAtLocation(const Rectangle:TFGRectangle; const CPoint:TFGPoint2D):TFGRectangle;
begin
...
function CenterAtLocation(const Quadix:TFGQuadix2D; const CPoint:TFGPoint2D):TFGQuadix2D;
begin
...
function CenterAtLocation(const Circle:TFGCircle; const CPoint:TFGPoint2D):TFGCircle;
begin
...
function CenterAtLocation(const Polygon:TFGPolygon2D; const CPoint:TFGPoint2D):TFGPolygon2D;
begin
...
function AABB(const Segment : TFGSegment2D):TFGRectangle;
begin
...
function AABB(const Triangle : TFGTriangle2D):TFGRectangle;
var
  i  : Integer;
begin
...
function AABB(const Rectangle : TFGRectangle):TFGRectangle;
begin
...
function AABB(const Quadix : TFGQuadix2D):TFGRectangle;
var
  i  : Integer;
begin
...
function AABB(const Circle : TFGCircle):TFGRectangle;
begin
...
function AABB(const Polygon : TFGPolygon2D):TFGRectangle;
var
  i  : Integer;
begin
...
function AABB(const Curve : TFGPoint2DArray):TFGRectangle;
var
  i  : Integer;
begin
...
procedure AABB(const Segment : TFGSegment2D; out x1,y1,x2,y2:TFloat);
var
   Rectangle : TFGRectangle;
begin
...
procedure AABB(const Triangle : TFGTriangle2D; out x1,y1,x2,y2:TFloat);
var
   Rectangle : TFGRectangle;
begin
...
procedure AABB(const Rectangle : TFGRectangle;  out x1,y1,x2,y2:TFloat);
var
   _Rectangle : TFGRectangle;
begin
...
procedure AABB(const Quadix : TFGQuadix2D; out x1,y1,x2,y2:TFloat);
var
   Rectangle : TFGRectangle;
begin
...
procedure AABB(const Circle : TFGCircle; out x1,y1,x2,y2:TFloat);
var
   Rectangle : TFGRectangle;
begin
...
procedure AABB(const Polygon : TFGPolygon2D; out x1,y1,x2,y2:TFloat);
var
   Rectangle : TFGRectangle;
begin
...
procedure AABB(const Curve : TFGPoint2DArray; out x1,y1,x2,y2:TFloat);
var
   Rectangle : TFGRectangle;
begin
...
function ProjectPoint(const SrcPoint,DstPoint:TFGPoint2D; const Dist:TFloat):TFGPoint2D;
begin
...
function ProjectPoint(const SrcPoint,DstPoint:TFGPoint3D; const Dist:TFloat):TFGPoint3D;
begin
...
function ProjectPoint(const Point:TFGPoint2D; Angle,Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint0(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint45(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint90(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint135(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint180(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint225(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint270(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectPoint315(const Point:TFGPoint2D; const Distance:TFloat):TFGPoint2D;
begin
...
function ProjectObject(const Point:TFGPoint2D; const Angle,Distance:TFloat):TFGPoint2D;
begin
...
function ProjectObject(const Segment:TFGSegment2D; const Angle,Distance:TFloat):TFGSegment2D;
begin
...
function ProjectObject(const Triangle:TFGTriangle2D; const Angle,Distance:TFloat):TFGTriangle2D;
begin
...
function ProjectObject(const Quadix:TFGQuadix2D; const Angle,Distance:TFloat):TFGQuadix2D;
begin
...
function ProjectObject(const Circle:TFGCircle; const Angle,Distance:TFloat):TFGCircle;
begin
...
function ProjectObject(const Polygon : TFGPolygon2D; const Angle,Distance:TFloat):TFGPolygon2D;
var
  i : Integer;
begin
  Setlength(Result,Length(Polygon));
...
procedure CalculateBezierCoefficients(const Bezier:TFGQuadraticBezier2D; out ax,bx,ay,by:TFloat);
begin
...
procedure CalculateBezierCoefficients(const Bezier:TFGQuadraticBezier3D; out ax,bx,ay,by,az,bz:TFloat);
begin
  bx := 2.0 * (Bezier[1].x - Bezier[0].x);
  by := 2.0 * (Bezier[1].y - Bezier[0].y);
...
procedure CalculateBezierCoefficients(const Bezier:TFGCubicBezier2D; out ax,bx,cx,ay,by,cy:TFloat);
begin
...
procedure CalculateBezierCoefficients(const Bezier:TFGCubicBezier3D; out ax,bx,cx,ay,by,cy,az,bz,cz:TFloat);
begin
  cx := 3.0 * (Bezier[1].x - Bezier[0].x);
  cy := 3.0 * (Bezier[1].y - Bezier[0].y);
...
function PointOnBezier(const StartPoint:TFGPoint2D; const ax,bx,ay,by,T:TFloat):TFGPoint2D;
var
  tSqr  : TFloat;
begin
  tSqr     := t * t;
...
function PointOnBezier(const StartPoint:TFGPoint3D; const ax,bx,ay,by,az,bz,T:TFloat):TFGPoint3D;
var
  tSqr  : TFloat;
begin
  tSqr     := t * t;
...
function PointOnBezier(const StartPoint:TFGPoint2D; const ax,bx,cx,ay,by,cy,T:TFloat):TFGPoint2D;
var
  tSqr  : TFloat;
  tCube : TFloat;
begin
...
function PointOnBezier(const StartPoint:TFGPoint3D; const ax,bx,cx,ay,by,cy,az,bz,cz,T:TFloat):TFGPoint3D;
var
  tSqr  : TFloat;
  tCube : TFloat;
begin
...
function CreateBezier(const Bezier:TFGQuadraticBezier2D; const PointCount:Integer) : TFGPoint2DArray;
var
  ax : TFloat;
  ay : TFloat;
  bx : TFloat;
...
function CreateBezier(const Bezier:TFGQuadraticBezier3D; const PointCount:Integer) : TFGPoint3DArray;
var
  ax : TFloat;
  ay : TFloat;
  az : TFloat;
...
function CreateBezier(const Bezier:TFGCubicBezier2D; const PointCount:Integer) : TFGPoint2DArray;
var
  ax : TFloat;
  bx : TFloat;
  cx : TFloat;
...
function CreateBezier(const Bezier:TFGCubicBezier3D; const PointCount:Integer) : TFGPoint3DArray;
var
  ax : TFloat;
  bx : TFloat;
  cx : TFloat;
...
function CreateCurvePointBezier(const Bezier:TFGQuadraticBezier2D; const PointCount:Integer):TFGCurvePoint2DArray;
var
  ax : TFloat;
  ay : TFloat;
  bx : TFloat;
...
function CreateCurvePointBezier(const Bezier:TFGQuadraticBezier3D; const PointCount:Integer):TFGCurvePoint3DArray;
var
  ax : TFloat;
  ay : TFloat;
  az : TFloat;
...
function CreateCurvePointBezier(const Bezier:TFGCubicBezier2D; const PointCount:Integer):TFGCurvePoint2DArray;
var
  ax : TFloat;
  bx : TFloat;
  cx : TFloat;
...
function CreateCurvePointBezier(const Bezier:TFGCubicBezier3D; const PointCount:Integer):TFGCurvePoint3DArray;
var
  ax : TFloat;
  bx : TFloat;
  cx : TFloat;
...
function CurveLength(const Bezier:TFGQuadraticBezier2D; const PointCount:Integer):TFloat;
var
   i     : Integer;
   Curve : TFGPoint2DArray;
begin
  Result := 0;
...
function CurveLength(const Bezier:TFGQuadraticBezier3D; const PointCount:Integer):TFloat;
var
   i     : Integer;
   Curve : TFGPoint3DArray;
begin
  Result := 0;
  Curve  := CreateBezier(Bezier,PointCount);
  for i := 0 To Length(Curve) - 2 do
...
function CurveLength(const Bezier:TFGCubicBezier2D; const PointCount:Integer):TFloat;
var
   i     : Integer;
   Curve : TFGPoint2DArray;
begin
...
function CurveLength(const Bezier:TFGCubicBezier3D; const PointCount:Integer):TFloat;
var
   i     : Integer;
   Curve : TFGPoint3DArray;
begin
...
function ShortenSegment(const Segment:TFGSegment2D; const Amount : TFloat):TFGSegment2D;
begin
  Result := Segment;
...
function ShortenSegment(const Segment:TFGSegment3D; const Amount : TFloat):TFGSegment3D;
begin
  Result := Segment;
...
function LengthenSegment(const Segment:TFGSegment2D; const Amount:TFloat):TFGSegment2D;
begin
  Result := Segment;
...
function LengthenSegment(const Segment:TFGSegment3D; const Amount:TFloat):TFGSegment3D;
begin
  Result := Segment;
...
function EquatePoint(const x,y:TFloat):TFGPoint2D;
begin
  Result.x := x;
  Result.y := y;
end;
...
function EquatePoint(const x,y,z:TFloat):TFGPoint3D;
begin
  Result.x := x;
  Result.y := y;
  Result.z := z;
...
function EquatePointPtr(const x,y:TFloat):TFGPoint2DPtr;
begin
  New(Result);
...
function EquatePointPtr(const x,y,z:TFloat):TFGPoint3DPtr;
begin
  New(Result);
...
procedure EquatePoint(const x,y:TFloat; out Point:TFGPoint2D);
begin
  Point.x := x;
  Point.y := y;
end;
...
procedure EquatePoint(const x,y,z:TFloat; out Point:TFGPoint3D);
begin
  Point.x := x;
  Point.y := y;
  Point.z := z;
...
procedure EquatePointPtr(const x,y:TFloat; out Point:TFGPoint2DPtr);
begin
...
procedure EquatePointPtr(const x,y,z:TFloat; out Point:TFGPoint3DPtr);
begin
...
function EquateCurvePoint(x,y,t:TFloat):TFGCurvePoint2D;
begin
  Result.x := x;
  Result.y := y;
  Result.t := t;
...
function EquateCurvePoint(x,y,z,t:TFloat):TFGCurvePoint3D;
begin
  Result.x := x;
  Result.y := y;
  Result.z := z;
...
function EquateCurvePoint(Point:TFGPoint2D; t:TFloat):TFGCurvePoint2D;
begin
  Result.x := Point.x;
  Result.y := Point.y;
  Result.t := t;
...
function EquateCurvePoint(Point:TFGPoint3D; t:TFloat):TFGCurvePoint3D;
begin
  Result.x := Point.x;
  Result.y := Point.y;
  Result.z := Point.z;
...
function EquateSegment(const x1,y1,x2,y2:TFloat):TFGSegment2D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function EquateSegment(const Point1,Point2:TFGPoint2D):TFGSegment2D;
begin
...
function EquateSegment(const Point1,Point2:TFGPoint3D):TFGSegment3D;
begin
...
function EquateSegment(const x1,y1,z1,x2,y2,z2:TFloat):TFGSegment3D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[1].z := z1;
...
procedure EquateSegment(const x1,y1,x2,y2:TFloat; out Segment:TFGSegment2D);
begin
  Segment[1].x := x1;
  Segment[1].y := y1;
  Segment[2].x := x2;
...
procedure EquateSegment(const x1,y1,z1,x2,y2,z2:TFloat; out Segment:TFGSegment3D);
begin
  Segment[1].x := x1;
  Segment[1].y := y1;
  Segment[1].z := z1;
...
function EquateLine(const x1,y1,x2,y2:TFloat):TFGLine2D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function EquateLine(const x1,y1,z1,x2,y2,z2:TFloat):TFGLine3D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[1].z := z1;
...
function EquateLine(const Point1,Point2:TFGPoint2D):TFGLine2D;
begin
...
function EquateLine(const Point1,Point2:TFGPoint3D):TFGLine3D;
begin
...
procedure EquateLine(const x1,y1,x2,y2:TFloat; out Line:TFGLine2D);
begin
  Line[1].x := x1;
  Line[1].y := y1;
  Line[2].x := x2;
...
procedure EquateLine(const x1,y1,z1,x2,y2,z2:TFloat; out Line:TFGLine3D);
begin
  Line[1].x := x1;
  Line[1].y := y1;
  Line[1].z := z1;
...
function EquateQuadix(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat):TFGQuadix2D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function EquateQuadix(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat):TFGQuadix3D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[1].z := z1;
...
function EquateQuadix(const Point1,Point2,Point3,Point4:TFGPoint2D):TFGQuadix2D;
begin
  Result := EquateQuadix(
                         Point1.x,Point1.y,
                         Point2.x,Point2.y,
...
function EquateQuadix(const Point1,Point2,Point3,Point4:TFGPoint3D):TFGQuadix3D;
begin
  Result := EquateQuadix(
...
procedure EquateQuadix(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out Quadix:TFGQuadix2D);
begin
  Quadix[1].x := x1;
  Quadix[1].y := y1;
  Quadix[2].x := x2;
...
procedure EquateQuadix(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; out Quadix:TFGQuadix3D);
begin
  Quadix[1].x := x1;
  Quadix[1].y := y1;
  Quadix[1].z := z1;
...
function EquateRectangle(const x1,y1,x2,y2:TFloat):TFGRectangle;
begin
  if x1 <= x2 then
  begin
    Result[1].x := x1;
...
function EquateRectangle(const Point1,Point2:TFGPoint2D):TFGRectangle;
begin
...
procedure EquateRectangle(const x1,y1,x2,y2:TFloat; out Rect:TFGRectangle);
begin
  if x1 <= x2 then
  begin
    Rect[1].x := x1;
...
procedure EquateRectangle(const Point1,Point2:TFGPoint2D; out Rect:TFGRectangle);
begin
...
function EquateTriangle(const x1,y1,x2,y2,x3,y3:TFloat):TFGTriangle2D;
begin
  Result[1].x := x1;
  Result[1].y := y1;
  Result[2].x := x2;
...
function EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat):TFGTriangle3D;
begin
  Result[1].x := x1;
  Result[2].x := x2;
  Result[3].x := x3;
...
function EquateTriangle(const Point1,Point2,Point3: TFGPoint2D):TFGTriangle2D;
begin
  Result[1] := Point1;
  Result[2] := Point2;
  Result[3] := Point3;
...
function EquateTriangle(const Point1,Point2,Point3: TFGPoint3D):TFGTriangle3D;
begin
 Result[1] := Point1;
 Result[2] := Point2;
 Result[3] := Point3;
...
procedure EquateTriangle(const x1,y1,x2,y2,x3,y3:TFloat; out Triangle:TFGTriangle2D);
begin
 Triangle[1].x := x1;
 Triangle[2].x := x2;
 Triangle[3].x := x3;
...
procedure EquateTriangle(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; out Triangle:TFGTriangle3D);
begin
  Triangle[1].x := x1;
  Triangle[2].x := x2;
  Triangle[3].x := x3;
...
procedure EquateTriangle(const Point1,Point2,Point3:TFGPoint2D; out Triangle:TFGTriangle2D);
begin
  Triangle[1] := Point1;
  Triangle[2] := Point2;
  Triangle[3] := Point3;
...
procedure EquateTriangle(const Point1,Point2,Point3:TFGPoint3D; out Triangle:TFGTriangle3D);
begin
  Triangle[1] := Point1;
  Triangle[2] := Point2;
  Triangle[3] := Point3;
...
function EquateCircle(const x,y,r:TFloat):TFGCircle;
begin
  Result.x      := x;
  Result.y      := y;
  Result.Radius := r;
...
function EquateCircle(const Point:TFGPoint2D; Radius:TFloat):TFGCircle;
begin
...
procedure EquateCircle(const x,y,r:TFloat; out Circle:TFGCircle);
begin
  Circle.x      := x;
  Circle.y      := y;
  Circle.Radius := r;
...
function EquateSphere(const x,y,z,r:TFloat):TFGSphere;
begin
  Result.x      := x;
  Result.y      := y;
  Result.z      := z;
...
procedure EquateSphere(const x,y,z,r:TFloat; out Sphere:TFGSphere);
begin
  Sphere.x      := x;
  Sphere.y      := y;
  Sphere.z      := z;
...
function EquatePlane(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat):TFGPlane2D;
begin
...
function EquatePlane(const Point1,Point2,Point3:TFGPoint3D):TFGPlane2D;
begin
...
procedure EquatePlane(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; out Plane:TFGPlane2D);
begin
...
procedure EquatePlane(const Point1,Point2,Point3:TFGPoint3D; out Plane:TFGPlane2D);
begin
...
procedure EquateBezier(const x1,y1,x2,y2,x3,y3:TFloat; out Bezier:TFGQuadraticBezier2D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[1].x := x2;
...
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3:TFloat; out Bezier:TFGQuadraticBezier3D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[0].z := z1;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3:TFGPoint2D):TFGQuadraticBezier2D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3:TFGPoint3D):TFGQuadraticBezier3D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
procedure EquateBezier(const x1,y1,x2,y2,x3,y3,x4,y4:TFloat; out Bezier:TFGCubicBezier2D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[1].x := x2;
...
procedure EquateBezier(const x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4:TFloat; out Bezier:TFGCubicBezier3D);
begin
  Bezier[0].x := x1;
  Bezier[0].y := y1;
  Bezier[0].z := z1;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TFGPoint2D):TFGCubicBezier2D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
function EquateBezier(const Pnt1,Pnt2,Pnt3,Pnt4:TFGPoint3D):TFGCubicBezier3D;
begin
  Result[0] := Pnt1;
  Result[1] := Pnt2;
  Result[2] := Pnt3;
...
function RectangleToQuadix(x1,y1,x2,y2:TFloat):TFGQuadix2D;
begin
...
function RectangleToQuadix(Point1,Point2:TFGPoint2D):TFGQuadix2D;
begin
...
function RectangleToQuadix(Rectangle:TFGRectangle):TFGQuadix2D;
begin
...
function TriangleToPolygon(x1,y1,x2,y2,x3,y3:TFloat):TFGPolygon2D;
begin
  SetLength(Result,3);
...
function TriangleToPolygon(Triangle:TFGTriangle2D):TFGPolygon2D;
begin
...
function QuadixToPolygon(x1,y1,x2,y2,x3,y3,x4,y4:TFloat):TFGPolygon2D;
begin
  SetLength(Result,4);
  Result[0] := EquatePoint(x1,y1);
  Result[1] := EquatePoint(x2,y2);
...
function QuadixToPolygon(Quadix:TFGQuadix2D):TFGPolygon2D;
begin
...
function CircleToPolygon(const Cx,Cy,Radius:TFloat; const PointCount:Integer):TFGPolygon2D;
var
  i     : Integer;
  Angle : TFloat;
begin
...
function CircleToPolygon(const Circle:TFGCircle; const PointCount:Integer):TFGPolygon2D;
begin
...
procedure SetGeometricObject(const Primitive:TFGPoint2D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGPoint3D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGLine2D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGLine3D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGSegment2D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGSegment3D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGTriangle2D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGTriangle3D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGQuadix2D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGQuadix3D; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGRectangle; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGCircle; out GeoObj:TGeometricObject);
begin
...
procedure SetGeometricObject(const Primitive:TFGSphere; out GeoObj:TGeometricObject);
begin
...
procedure GenerateRandomPoints(const Bx1,By1,Bx2,By2:TFloat; var PointList: array of TFGPoint2D);
var
  i  : Integer;
  Dx : TFloat;
  Dy : TFloat;
...
procedure GenerateRandomPoints(const Rectangle:TFGRectangle; var PointList: array of TFGPoint2D);
begin
...
procedure GenerateRandomPoints(const Segment:TFGSegment2D; var PointList:array of TFGPoint2D);
var
  i     : Integer;
  Ratio : TFloat;
begin
...
procedure GenerateRandomPoints(const Segment:TFGSegment3D; var PointList:array of TFGPoint3D);
var
  i     : Integer;
  Ratio : TFloat;
begin
...
procedure GenerateRandomPoints(const Triangle:TFGTriangle2D; var PointList:array of TFGPoint2D);
var
  a : TFloat;
  b : TFloat;
  c : TFloat;
...
procedure GenerateRandomPoints(const Triangle:TFGTriangle3D; var PointList:array of TFGPoint3D);
var
  a : TFloat;
  b : TFloat;
  c : TFloat;
...
procedure GenerateRandomPoints(const Circle:TFGCircle; var PointList:array of TFGPoint2D);
var
  i           : Integer;
  RandomAngle : TFloat;
  CPoint      : TFGPoint2D;
...
procedure GenerateRandomPoints(const Quadix:TFGQuadix2D; var PointList : array of TFGPoint2D);
...
procedure GenerateRandomPoints(const Quadix:TFGQuadix3D; var PointList : array of TFGPoint3D);
(*  Note: It is assumed the input Quadix is convex. *)
var
  i  : Integer;
  a  : TFloat;
...
var
  i            : Integer;
  Triangle     : TFGTriangle2D;
  Quadix       : TFGQuadix2D;
  QRndPoint    : array of TFGPoint2D;
  TRndPoint    : array of TFGPoint2D;
  QRndPntCnt   : Integer;
  TRndPntCnt   : Integer;
begin
...
var
  ...
  Quadix1     : TFGQuadix2D;
  Quadix2     : TFGQuadix2D;
  Q1RndPoint  : array of TFGPoint2D;
  Q2RndPoint  : array of TFGPoint2D;
  Q1RndPntCnt : Integer;
  Q2RndPntCnt : Integer;
begin
...
var
  ...
  Q1RndPoint  : array of TFGPoint2D;
  Q2RndPoint  : array of TFGPoint2D;
  Q3RndPoint  : array of TFGPoint2D;
  Q1RndPntCnt : Integer;
  Q2RndPntCnt : Integer;
  Q3RndPntCnt : Integer;
begin
...
function Add(const Vec1,Vec2:TFGVector2D):TFGVector2D;
begin
...
function Add(const Vec1,Vec2:TFGVector3D):TFGVector3D;
begin
  Result.x := Vec1.x + Vec2.x;
  Result.y := Vec1.y + Vec2.y;
...
function Add(const Vec:TFGVector2DArray):TFGVector2D;
var
  i : Integer;
begin
  Result.x := Zero;
...
function Add(const Vec:TFGVector3DArray):TFGVector3D;
var
  i : Integer;
begin
  Result.x := Zero;
...
function Add(const Vec1,Vec2:TFGVector2DArray):TFGVector2DArray;
var
  i : Integer;
begin
...
function Add(const Vec1,Vec2:TFGVector3DArray):TFGVector3DArray;
var
  i : Integer;
begin
  SetLength(Result,Min(Length(Vec1),Length(Vec2)));
...
function Sub(const Vec1,Vec2:TFGVector2D):TFGVector2D;
begin
  Result.x := Vec1.x - Vec2.x;
  Result.y := Vec1.y - Vec2.y;
end;
...
function Sub(const Vec1,Vec2:TFGVector3D):TFGVector3D;
begin
  Result.x := Vec1.x - Vec2.x;
  Result.y := Vec1.y - Vec2.y;
  Result.z := Vec1.z - Vec2.z;
...
function Sub(const Vec1,Vec2:TFGVector2DArray):TFGVector2DArray;
var
  i : Integer;
begin
  SetLength(Result,Min(Length(Vec1),Length(Vec2)));
...
function Sub(const Vec1,Vec2:TFGVector3DArray):TFGVector3DArray;
var
  i : Integer;
begin
  SetLength(Result,Min(Length(Vec1),Length(Vec2)));
...
function Mul(const Vec1,Vec2:TFGVector2D):TFGVector3D;
begin
end;
(* End of *)


function Mul(const Vec1,Vec2:TFGVector3D):TFGVector3D;
begin
...
function Mul(const Vec1,Vec2:TFGVector3DArray):TFGVector3DArray;
var
  i : Integer;
begin
  SetLength(Result,Min(Length(Vec1),Length(Vec2)));
...
function UnitVector(const Vec:TFGVector2D):TFGVector2D;
var
  Mag : TFloat;
begin
  Mag := Magnitude(Vec);
...
function UnitVector(const Vec:TFGVector3D):TFGVector3D;
var
  Mag : TFloat;
begin
  Mag := Magnitude(Vec);
...
function Magnitude(const Vec:TFGVector2D):TFloat;
begin
...
function Magnitude(const Vec:TFGVector3D):TFloat;
begin
...
function DotProduct(const Vec1,Vec2:TFGVector2D):TFloat;
begin
...
function DotProduct(const Vec1,Vec2:TFGVector3D):TFloat;
begin
...
function Scale(const Vec:TFGVector2D; const Factor:TFloat):TFGVector2D;
begin
...
function Scale(const Vec:TFGVector3D; const Factor:TFloat):TFGVector3D;
begin
  Result.x := Vec.x * Factor;
  Result.y := Vec.y * Factor;
...
function Scale(const Vec:TFGVector2DArray; const Factor:TFloat):TFGVector2DArray;
var
  i : Integer;
begin
...
function Scale(const Vec:TFGVector3DArray; const Factor:TFloat):TFGVector3DArray;
var
  i : Integer;
begin
  SetLength(Result,Length(Vec));
...
function Negate(const Vec:TFGVector2D):TFGVector2D;
begin
  Result.x := -Vec.x;
  Result.y := -Vec.y;
end;
...
function Negate(const Vec:TFGVector3D):TFGVector3D;
begin
  Result.x := -Vec.x;
  Result.y := -Vec.y;
  Result.z := -Vec.z;
...
function Negate(Vec:TFGVector2DArray):TFGVector2DArray;
var
  i : Integer;
begin
  SetLength(Result,Length(Vec));
...
function Negate(Vec:TFGVector3DArray):TFGVector3DArray;
var
  i : Integer;
begin
  SetLength(Result,Length(Vec));
...
function IsEqual(const Point1,Point2:TFGPoint2D; const Epsilon:TFloat):Boolean;
begin
...
function IsEqual(const Point1,Point2:TFGPoint3D; const Epsilon:TFloat):Boolean;
begin
...
function IsEqual(const Point1,Point2:TFGPoint2D):Boolean;
begin
  Result := (IsEqual(Point1.x,Point2.x,Epsilon) and IsEqual(Point1.y,Point2.y,Epsilon));
end;
(* End of Is Equal *)
...
function IsEqual(const Point1,Point2:TFGPoint3D):Boolean;
begin
  Result := (IsEqual(Point1.x,Point2.x,Epsilon) and IsEqual(Point1.y,Point2.y,Epsilon) and IsEqual(Point1.z,Point2.z,Epsilon));
end;
(* End of Is Equal *)
...
function NotEqual(const Point1,Point2:TFGPoint2D; const Epsilon:TFloat):Boolean;
begin
...
function NotEqual(const Point1,Point2:TFGPoint3D; const Epsilon:TFloat):Boolean;
begin
...
function NotEqual(const Point1,Point2:TFGPoint2D):Boolean;
begin
  Result := (NotEqual(Point1.x,Point2.x,Epsilon) or NotEqual(Point1.y,Point2.y,Epsilon));
end;
(* End of not Equal *)
...
function NotEqual(const Point1,Point2:TFGPoint3D):Boolean;
begin
  Result := (NotEqual(Point1.x,Point2.x,Epsilon) or NotEqual(Point1.y,Point2.y,Epsilon) or NotEqual(Point1.z,Point2.z,Epsilon));
end;
(* End of not Equal *)
...
function IsDegenerate(const Segment:TFGSegment2D):Boolean;
begin
...
function IsDegenerate(const Line:TFGLine2D):Boolean;
begin
...
function IsDegenerate(const Segment:TFGSegment3D):Boolean;
begin
...
function IsDegenerate(const Line:TFGLine3D):Boolean;
begin
...
function IsDegenerate(const Triangle:TFGTriangle2D):Boolean;
begin
...
function IsDegenerate(const Triangle:TFGTriangle3D):Boolean;
begin
  Result := (IsEqual(Triangle[1],Triangle[2]))                   or
            (IsEqual(Triangle[1],Triangle[3]))                   or
            (IsEqual(Triangle[2],Triangle[3]))                   or
...
function IsDegenerate(const Quadix:TFGQuadix2D):Boolean;
begin
  Result :=
...
function IsDegenerate(const Quadix:TFGQuadix3D):Boolean;
begin
  Result :=
          (* Stage 1 unique points check *)
...
function IsDegenerate(const Rect:TFGRectangle):Boolean;
begin
...
function IsDegenerate(const Circle:TFGCircle):Boolean;
begin
...
function IsDegenerate(const Sphere:TFGSphere):Boolean;
begin
...
function IsDegenerate(const Arc:TFGCircularArc2D):Boolean;
begin
  with Arc do
...
procedure Swap(var Point1,Point2:TFGPoint2D);
begin
...
procedure Swap(var Point1,Point2:TFGPoint3D);
begin
  Swap(Point1.x,Point2.x);
  Swap(Point1.y,Point2.y);
...
procedure Swap(var Segment1,Segment2:TFGSegment2D);
begin
...
procedure Swap(var Segment1,Segment2:TFGSegment3D);
begin
  Swap(Segment1[1],Segment2[1]);
  Swap(Segment1[2],Segment2[2]);
end;
...
procedure Swap(var Line1,Line2:TFGLine2D);
begin
...
procedure Swap(var Triangle1,Triangle2:TFGTriangle2D);
begin
...
procedure Swap(var Triangle1,Triangle2:TFGTriangle3D);
begin
  Swap(Triangle1[1],Triangle2[1]);
  Swap(Triangle1[2],Triangle2[2]);
  Swap(Triangle1[3],Triangle2[3]);
...
procedure Swap(var Quadix1,Quadix2:TFGQuadix2D);
begin
...
procedure Swap(var Quadix1,Quadix2:TFGQuadix3D);
begin
  Swap(Quadix1[1],Quadix2[1]);
  Swap(Quadix1[2],Quadix2[2]);
  Swap(Quadix1[3],Quadix2[3]);
...
procedure Swap(var Circle1,Circle2:TFGCircle);
begin
...
procedure Swap(var Sphere1,Sphere2:TFGSphere);
begin
...
procedure Swap(var Arc1,Arc2:TFGCircularArc2D);
begin
