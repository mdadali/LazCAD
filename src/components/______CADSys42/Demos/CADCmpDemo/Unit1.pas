...
type
  ...
  TForm1 = class(TForm)
    ...
    Button5: TButton;
    Button6: TButton;
    procedure CSViewportMouseMove2D(Sender: TObject; Shift: TShiftState; WX,
...
procedure TForm1.CSViewportMouseMove2D(Sender: TObject; Shift: TShiftState; WX, WY: TRealType; X, Y: Integer);
...
begin
  ...
  begin
    ...
    begin
      TmpObj := hDrawing.CADViewport2D.PickObject(hDrawing.CADPrg2D.CurrentViewportSnappedPoint, 20, False, TmpN);
...
begin
  ...
  TmpPrimitive2D.Points[APointNr] := TransformPoint2D(hDrawing.CADPrg2D.CurrentViewportSnappedPoint, hTrans); //TransformPoint2D(CADPrg2D1.CurrentViewportSnappedPoint, AObject.ModelTransform);
