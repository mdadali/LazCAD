...
begin
 ...
 CL.AddDelphiFunction('Function cuSqrt( AValue : double) : double');
 CL.AddDelphiFunction('Function cuSqr( AValue : double) : double');
 CL.AddDelphiFunction('Function cuPi : double');
 CL.AddDelphiFunction('Function cuDegToRad( AAngle : double) : double');
 CL.AddDelphiFunction('Function cuRadToDeg( AAngle : double) : double');
 CL.AddDelphiFunction('Function cuGetAngleFromPoints( Ax1, Ay1, Ax2, Ay2 : double) : double');
 CL.AddDelphiFunction('Function cuPointsDistance2D( ex, sx, ey, sy : double) : double');
 CL.AddDelphiFunction('Procedure cuSwapPoints( var Ax1 : double; var Ay1 : double; var Ax2 : double; var Ay2 : double)');
 CL.AddDelphiFunction('Procedure cuSwapAngle( var AAngle1 : double; var AAngle2 : double)');
